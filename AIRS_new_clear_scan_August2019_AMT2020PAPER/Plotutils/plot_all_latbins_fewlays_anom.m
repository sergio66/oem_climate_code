...
iDir = topts.ocb_set;
if iDir == 0
  outputdir = ['OutputAnomaly_OBS/'];
elseif iDir == 1
  outputdir = ['OutputAnomaly_CAL/'];
end
...
ii = 21;
filex = [outputdir '/' num2str(ii,'%02d') '/anomtest_timestep' num2str(driver.i16daytimestep) '.mat'];
driver = load(filex);
