...
for ii = 1 : 40
  ...
  for iTime = 1 : 365
    ...
    if exist(fname) & iaaFound(ii,mapp(iTime)) == 0
      ...
      nlays = length(a.oem.tunc);
      if co2lays == 1
        wvind = (1:nlays) + 0*nlays + 5;
        tzind = (1:nlays) + 1*nlays + 5;
        o3ind = (1:nlays) + 2*nlays + 5;
      elseif co2lays == 3
        wvind = (1:nlays) + 0*nlays + 7;
        tzind = (1:nlays) + 1*nlays + 7;
        o3ind = (1:nlays) + 2*nlays + 7;
      end
