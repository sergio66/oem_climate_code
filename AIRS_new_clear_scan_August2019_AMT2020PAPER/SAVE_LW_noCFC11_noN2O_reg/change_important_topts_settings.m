...
topts.numchan = 2645;
topts.chan_LW_SW =  0;  %% just LW/MW DEFAULT, keep strat T chans
%% topts.chan_LW_SW = -1;  %% all chans,LW/MW and SW, keep strat T chans <<<<<<<
%% topts.chan_LW_SW = +1;  %% LW/MW but avoid deep 15 um
%% topts.chan_LW_SW = +2;  %% LW/MW/SW but avoid deep 15 um not yet coded
