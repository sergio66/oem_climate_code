...
%fprintf(1,'nov 30 A : length(ch) = %4i \n',length(ch))
  newbadlist_dec1_2019 = [1621 1622 1624 1644];
    ch = setdiff(ch,newbadlist_dec1_2019);
%fprintf(1,'nov 30 B : length(ch) = %4i \n',length(ch))
...
%fprintf(1,'nov 30 C : length(ch) = %4i %4i %4i\n',length(newbadlist_dec1_2019),length(no_more_cfc11),length(ch))
