...
for iLatbin = iLS : iLE
  ...
  if i_obsORcal > 0
    saver = ['save ANOM_16dayavg_nonucal/latbin_' num2str(iAvgNumDays) 'dayavg_' num2str(iLatbin) '.mat avg16_rtime avg_doy_since2002 avg16_btanom comment'];
  elseif i_obsORcal < 0
    saver = ['save ANOM_16dayavg_nonucal/latbin_' num2str(iAvgNumDays) 'dayavg_' num2str(iLatbin) '_cal.mat avg16_rtime avg_doy_since2002 avg16_btanom comment'];
  end
