...
%% for June 4, 2019
  fname1 = ['/home/strow/Work/Airs/Stability/Data/Desc_fits_iasi_times/Small/fit_robs_lat' num2str(ix) '.mat'];   %% exists
  fname2 = ['/home/strow/Work/Airs/Stability/Data/Desc_fits_iasi_times/Small/fit_rclr_lat' num2str(ix) '.mat'];   %% exists
  fname3 = ['/home/strow/Work/Airs/Stability/Data/Desc_fits_iasi_times/Small/fit_rbias_lat' num2str(ix) '.mat'];  %% exists
...
comment = 'from /home/strow/Work/Airs/Stability/Data/Desc_fits_iasi_times/Small/fit_* and convert_strowrates2oemrates_airs_iasitimespan.m';
save convert_strowrates2oemrates_clear_11year_iasitimespan_obs_cal_bias.mat b_* comment lagcor*
