...
if ~exist('jacmeanTrop','var') & ~exist('ind_components','var')
  if ~exist('/home/sergio/MATLABCODE/oem_pkg_run_sergio_AuxJacs/MakeJacskCARTA_CLR/Anomaly365_16_12p8/RESULTS/only_tropics_jacs_ind_components.mat')
    ...
    save -v7.3 /home/sergio/MATLABCODE/oem_pkg_run_sergio_AuxJacs/MakeJacskCARTA_CLR/Anomaly365_16_12p8/RESULTS/only_tropics_ind_components.mat f qrenorm ind_*
  else
    load /home/sergio/MATLABCODE/oem_pkg_run_sergio_AuxJacs/MakeJacskCARTA_CLR/Anomaly365_16_12p8/RESULTS/only_tropics_ind_components.mat
  end
end
