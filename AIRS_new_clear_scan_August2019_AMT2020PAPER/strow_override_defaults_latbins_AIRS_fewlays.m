...
if driver.i16daytimestep < 0
  ...
  iMidPoint_TimeStepUse = 365;          %% put in constant Jacobian, at timestep 365 (2018/08)
  iMidPoint_TimeStepUse = floor(365/2); %% put in constant Jacobian, half way through (365/2 ==> 2009/09)

  iMidPoint_TimeStepUse = 270; 
  iMidPoint_TimeStepUse = 335; 
  iMidPoint_TimeStepUse = 180; %% default "fool" the code by using midpoint anomaly jac
  ...
  elseif settings.descORasc == +1
    ...
    driver.jacobian.filename = '/home/sergio/MATLABCODE/oem_pkg_run_sergio_AuxJacs/MakeJacskCARTA_CLR/JUNK/kcarta_M_TS_jac_all_5_97_97_97_2645.mat';             %% hmm disappeared
    driver.jacobian.filename = '/home/sergio/MATLABCODE/oem_pkg_run_sergio_AuxJacs/MakeJacskCARTA_CLR/Anomaly365_16_12p8/RESULTS/avgjac2010_kcarta__M_TS_jac_all_5_97_97_97_2645.mat'; %% new Sept 2020
    driver.jacobian.filename = '/home/sergio/MATLABCODE/oem_pkg_run_sergio_AuxJacs/MakeJacskCARTA_CLR/JUNK_June03_2019/kcarta_M_TS_jac_all_5_97_97_97_2645.mat'; %% worked pretty well late Aug 2020
    fprintf(1,'reading in constant kcarta jac file %s \n',driver.jacobian.filename)
  end
...
if settings.UMBCvsERAjac == 1
  disp('adjusting jacobian based on clear sky retrievals, all jacobians (colgas,stemp,WV(z),T(z),O3(z))')
  addpath /home/sergio/MATLABCODE/oem_pkg_run/AIRS_new_clear_scan_August2019/NewJacs_forAMT2020
  m_ts_jac0 = add_deltaJ_to_jacs(m_ts_jac0,driver.iibin,+1);
end
...
[sum(abs(m_ts_jac_wv(:))) sum(abs(m_ts_jac_t(:))) sum(abs(m_ts_jac_o3(:)))]
...
elseif driver.i16daytimestep < 0
  ...
  elseif iXJac == 1 | iXJac == 2
    ...
    m_ts_jac_coljac = replace_time_cfc11jac(m_ts_jac_coljac,driver.iibin,iMidPoint_TimeStepUse,3); %% added this on 8/21
    m_ts_jac_coljac = replace_time_cfc12jac(m_ts_jac_coljac,driver.iibin,iMidPoint_TimeStepUse,3); %% added this on 8/21
  end
end
