...
elseif iSmooth == 0.5
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fUMBC_day.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS\_RT DAY');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fUMBC_night.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS\_RT NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fERA5_day.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : ERA5 DAY');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fERA5_night.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : ERA5 NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fAIRSL3_day.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS L3 DAY');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fAIRSL3_night.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS L3 NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fCLIMCAPSL3_day.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : CLIMCAPS L3 DAY');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fCLIMCAPSL3_night.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : CLIMCAPS L3 NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape(fMERRA2.RHsurftrend,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : MERRA2 DAY/NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape((fUMBC_day.RHsurftrend+fUMBC_night.RHsurftrend)*0.5,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS\_RT DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape((fAIRSL3_day.RHsurftrend+fAIRSL3_night.RHsurftrend)*0.5,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS L3 DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape((fCLIMCAPSL3_day.RHsurftrend+fCLIMCAPSL3_night.RHsurftrend)*0.5,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : CLIMCAPS L3 DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape((fERA5_day.RHsurftrend+fERA5_night.RHsurftrend)*0.5,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : ERA5 DAY/NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape((fUMBC_day.RHsurftrend-fUMBC_night.RHsurftrend)*1.0,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS\_RT DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape((fAIRSL3_day.RHsurftrend-fAIRSL3_night.RHsurftrend)*1.0,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS L3 DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape((fCLIMCAPSL3_day.RHsurftrend-fCLIMCAPSL3_night.RHsurftrend)*1.0,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : CLIMCAPS L3 DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,smoothdata(reshape((fERA5_day.RHsurftrend-fERA5_night.RHsurftrend)*1.0,72,64)',"movmean",5),[-90 +90],[-180 +180]); title('dRHsurf/dt : ERA5 DAY - NIGHT');

elseif iSmooth <= 0
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fUMBC_day.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS\_RT DAY');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fUMBC_night.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS\_RT NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fERA5_day.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : ERA5 DAY');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fERA5_night.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : ERA5 NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fAIRSL3_day.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS L3 DAY');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fAIRSL3_night.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS L3 NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fCLIMCAPSL3_day.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : CLIMCAPS L3 DAY');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fCLIMCAPSL3_night.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : CLIMCAPS L3 NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape(fMERRA2.RHsurftrend,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : MERRA2 DAY/NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape((fUMBC_day.RHsurftrend+fUMBC_night.RHsurftrend)*0.5,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS\_RT DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape((fAIRSL3_day.RHsurftrend+fAIRSL3_night.RHsurftrend)*0.5,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS L3 DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape((fCLIMCAPSL3_day.RHsurftrend+fCLIMCAPSL3_night.RHsurftrend)*0.5,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : CLIMCAPS L3 DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape((fERA5_day.RHsurftrend+fERA5_night.RHsurftrend)*0.5,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : ERA5 DAY/NIGHT');
  
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape((fUMBC_day.RHsurftrend-fUMBC_night.RHsurftrend)*1.0,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS\_RT DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape((fAIRSL3_day.RHsurftrend-fAIRSL3_night.RHsurftrend)*1.0,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : AIRS L3 DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape((fCLIMCAPSL3_day.RHsurftrend-fCLIMCAPSL3_night.RHsurftrend)*1.0,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : CLIMCAPS L3 DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; aslmap(ii,rlat65,rlon73,reshape((fERA5_day.RHsurftrend-fERA5_night.RHsurftrend)*1.0,72,64)',[-90 +90],[-180 +180]); title('dRHsurf/dt : ERA5 DAY - NIGHT');
...
elseif iSmooth == 0.5
  iFig = 73; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,smoothdata(reshape(nanmean(junk,2),72,64)',"movmean",5),[-90 +90],[-180 +180]);   cx = [-1 +1]*0.151; caxis(cx); colormap(llsmap5);
  iFig = 74; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,smoothdata(reshape(nanstd(junk,[],2),72,64)',"movmean",5),[-90 +90],[-180 +180]); cx = [0 +1]*0.071;  caxis(cx); colormap(jet);
  
  iFig = 75; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,smoothdata(reshape(moo3,72,64)',"movmean",5),[-90 +90],[-180 +180]); cx = [0 +1];  caxis(cx); colormap(jet);
  iFig = 75; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(moo3,72,64)',[-90 +90],[-180 +180]); cx = [0 +1]; caxis(cx); colormap(usa2x);
  
  iFig = 76; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(moo4,72,64)',[-90 +90],[-180 +180]);        cx = [0 +2]; caxis(cx); colormap(usa2x);
  iFig = 76; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(10.^(moo4),72,64)',[-90 +90],[-180 +180]);  cx = (10.^[0 +1]); caxis(cx); colormap(jett);
  
  iFig = 77; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,smoothdata(reshape(mooUMBC_num,72,64)',"movmean",5),[-90 +90],[-180 +180]);   cx = ([-1 +1]*0.15); caxis(cx); colormap(llsmap5);
  iFig = 78; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,smoothdata(reshape(mooUMBC_denom,72,64)',"movmean",5),[-90 +90],[-180 +180]); cx = ([0 +1]*0.15/2); caxis(cx); colormap(jet);
  iFig = 79; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(10.^(mooUMBC),72,64)',[-90 +90],[-180 +180]);            cx = (10.^[0 +1]); caxis(cx); colormap(jett);
  iFig = 79; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(mooUMBC,72,64)',[-90 +90],[-180 +180]);                  cx = ([0 +5]); caxis(cx); colormap(jett);

elseif iSmooth <= 0
  iFig = 73; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(nanmean(junk,2),72,64)',[-90 +90],[-180 +180]);   cx = [-1 +1]*0.151; caxis(cx); colormap(llsmap5);
  iFig = 74; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(nanstd(junk,[],2),72,64)',[-90 +90],[-180 +180]); cx = [0 +1]*0.071;  caxis(cx); colormap(jet);
  
  iFig = 75; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(moo3,72,64)',[-90 +90],[-180 +180]); cx = [0 +1];  caxis(cx); colormap(jet);
  iFig = 75; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(moo3,72,64)',[-90 +90],[-180 +180]); cx = [0 +1]; caxis(cx); colormap(usa2x);
  
  iFig = 76; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(moo4,72,64)',[-90 +90],[-180 +180]);        cx = [0 +2]; caxis(cx); colormap(usa2x);
  iFig = 76; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(10.^(moo4),72,64)',[-90 +90],[-180 +180]);  cx = (10.^[0 +1]); caxis(cx); colormap(jett);
  
  iFig = 77; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(mooUMBC_num,72,64)',[-90 +90],[-180 +180]);   cx = ([-1 +1]*0.15); caxis(cx); colormap(llsmap5);
  iFig = 78; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(mooUMBC_denom,72,64)',[-90 +90],[-180 +180]); cx = ([0 +1]*0.15/2); caxis(cx); colormap(jet);
  iFig = 79; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(10.^(mooUMBC),72,64)',[-90 +90],[-180 +180]);            cx = (10.^[0 +1]); caxis(cx); colormap(jett);
  iFig = 79; figure(iFig); clf; aslmap(iFig,rlat65,rlon73,reshape(mooUMBC,72,64)',[-90 +90],[-180 +180]);                  cx = ([0 +5]); caxis(cx); colormap(jett);
end
...
figure(96); clf
  ...
  tfov(1) = nexttile;
    ...
    text(-2.5,1.15,'(a)')
  tfov(2) = nexttile;
    aslmapSergio(rlat65,rlon73,wah2,[-90 +90],[-180 +180]); colormap(tfov(2),jet); caxis([ 0 +1]*0.151); colorbar
    text(-2.5,1.15,'(b)')
