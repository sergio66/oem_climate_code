...
%%% 
tafov(4) = nexttile;  imagesc(squeeze(allXchi(2,regions,:))'); colormap(tafov(4),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames(1:4))
  set(gca,'xtick',[1:4],'xticklabel',{'GLOBAL','TROPICAL','MIDLAT','POLAR'});
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
...
tafov(6) = nexttile;  imagesc(squeeze(allXchi(8,regions,:))'); colormap(tafov(6),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames(1:4))
  set(gca,'xtick',[1:4],'xticklabel',{'GLOBAL','TROPICAL','MIDLAT','POLAR'});
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
...
%%% 
tafov(7) = nexttile;  imagesc(squeeze(allXchi(3,regions,:))'); colormap(tafov(7),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames(1:4))
  set(gca,'xtick',[1:4],'xticklabel',{'GLOBAL','TROPICAL','MIDLAT','POLAR'});
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  %t = title('RH'); t.FontSize = 10; t.FontWeight = 'normal';
...
tafov(8) = nexttile;  imagesc(squeeze(allXchi(6,regions,:))'); colormap(tafov(8),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames(1:4))
  set(gca,'xtick',[1:4],'xticklabel',{'GLOBAL','TROPICAL','MIDLAT','POLAR'});
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  %t = title('WV'); t.FontSize = 10; t.FontWeight = 'normal';
...
tafov(9) = nexttile;  imagesc(squeeze(allXchi(7,regions,:))'); colormap(tafov(9),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames(1:4))
  set(gca,'xtick',[1:4],'xticklabel',{'GLOBAL','TROPICAL','MIDLAT','POLAR'});
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  %t = title('T'); t.FontSize = 10; t.FontWeight = 'normal';
