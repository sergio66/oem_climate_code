...
%% 100 - 400 mb
tafov(1) = nexttile; imagesc([R_WV_global(2:5,2) R_WV_tropical(2:5,2) R_WV_midlat(2:5,2) R_WV_polar(2:5,2)]); colormap(tafov(1),jet); caxis([0 +1]); 
...
%% 400 - 1000 mb
tafov(6) = nexttile; imagesc([R_WV_global(2:5,3) R_WV_tropical(2:5,3) R_WV_midlat(2:5,3) R_WV_polar(2:5,3)]); colormap(tafov(6),jet); caxis([0 +1]); 
  colorbar('southoutside');
  set(gca,'ytick',[1:4],'yticklabel',varnames(2:5))
  set(gca,'xtick',[1:4],'xticklabel',{'GLOBAL','TROPICAL','MIDLAT','POLAR'}); 
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
...
tafov(7) = nexttile; imagesc([Slope_WV_global(2:5,3) Slope_WV_tropical(2:5,3) Slope_WV_midlat(2:5,3) Slope_WV_polar(2:5,3)]); colormap(tafov(7),usa); caxis([-1 +1]); 
  colorbar('southoutside');
  set(gca,'ytick',[1:4],'yticklabel',varnames(2:5))
  set(gca,'xtick',[1:4],'xticklabel',{'GLOBAL','TROPICAL','MIDLAT','POLAR'}); 
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
