...
figure(20); sergioprintfig([dir0 '/nosmooth_skt_Day_versus_Night_4panel']);
...
figure(42); sergioprintfig([dir0 '/nosmooth_tz_Day_Night_avg_5panel']);
...
figure(52); sergioprintfig([dir0 '/nosmooth_wvz_Day_Night_avg_5panel']);
...
figure(92); sergioprintfig([dir0 '/nosmooth_mmw_trends_5results'])
