...
disp('assumes you have run driver_computeERA5_monthly_trends_desc_or_asc.m');
...
%for JOB = 1 : iNumYears*12
  ...
  fnameOUT = ['OLR_ecRad/ERA5/era5_olr_' num2str(JOB,'%03d') '.mat'];
  if ~exist(fnameOUT)    
    fnameIN = ['/asl/s1/sergio/MakeAvgObsStats2002_2020_startSept2002_v3/TimeSeries/ERA5/Tile_Center/DESC/era5_tile_center_monthly_' num2str(JOB,'%03d') '.mat'];
    loader = ['load ' fnameIN];
    eval(loader);
    clear fnameIN
    ...
    stemp = px.stemp;
    saver = ['save OLR_ecRad/ERA5/era5_olr_' num2str(JOB,'%03d') '.mat stemp olr'];
    eval(saver)
  end
%end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%computeERA5_OLR_trend
