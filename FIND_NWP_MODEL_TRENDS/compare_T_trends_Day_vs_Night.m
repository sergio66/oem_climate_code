...
elseif iSmooth == 0.5
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fUMBC_day.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : AIRS\_RT DAY');
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fUMBC_night.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : AIRS\_RT NIGHT');
  
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fERA5_day.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : ERA5 DAY');
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fERA5_night.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : ERA5 NIGHT');
  
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fAIRSL3_day.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : AIRSL3 DAY');
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fAIRSL3_night.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : AIRSL3 NIGHT');
  
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fCLIMCAPSL3_day.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : CLIMCAPSL3 DAY');
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fCLIMCAPSL3_night.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : CLIMCAPSL3 NIGHT');
  
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,smoothdata(squeeze(nanmean(reshape(fMERRA2.ptemptrend,100,72,64),2)),"movmean",5)); title('dT/dt : MERRA2 DAY');
  
  ii = ii + 1; figure(ii); clf; junk = smoothdata(squeeze(nanmean(reshape(fUMBC_day.ptemptrend + fUMBC_night.ptemptrend,100,72,64),2)),"movmean",5); pcolor(rlat,plays100,junk/2); title('dT/dt : AIRS\_RT DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; junk = smoothdata(squeeze(nanmean(reshape(fERA5_day.ptemptrend + fERA5_night.ptemptrend,100,72,64),2)),"movmean",5); pcolor(rlat,plays100,junk/2); title('dT/dt : ERA5 DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; junk = smoothdata(squeeze(nanmean(reshape(fAIRSL3_day.ptemptrend + fAIRSL3_night.ptemptrend,100,72,64),2)),"movmean",5); pcolor(rlat,plays100,junk/2); title('dT/dt : AIRSL3 DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; junk = smoothdata(squeeze(nanmean(reshape(fCLIMCAPSL3_day.ptemptrend + fCLIMCAPSL3_night.ptemptrend,100,72,64),2)),"movmean",5); pcolor(rlat,plays100,junk/2); title('dT/dt : CLIMCAPSL3 DAY/NIGHT');
  
  ii = ii + 1; figure(ii); clf; junk = smoothdata(squeeze(nanmean(reshape(fUMBC_day.ptemptrend - fUMBC_night.ptemptrend,100,72,64),2)),"movmean",5); pcolor(rlat,plays100,junk/1); title('dT/dt : AIRS\_RT DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; junk = smoothdata(squeeze(nanmean(reshape(fERA5_day.ptemptrend - fERA5_night.ptemptrend,100,72,64),2)),"movmean",5); pcolor(rlat,plays100,junk/1); title('dT/dt : ERA5 DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; junk = smoothdata(squeeze(nanmean(reshape(fAIRSL3_day.ptemptrend - fAIRSL3_night.ptemptrend,100,72,64),2)),"movmean",5); pcolor(rlat,plays100,junk/1); title('dT/dt : AIRSL3 DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; junk = smoothdata(squeeze(nanmean(reshape(fCLIMCAPSL3_day.ptemptrend - fCLIMCAPSL3_night.ptemptrend,100,72,64),2)),"movmean",5); pcolor(rlat,plays100,junk/1); title('dT/dt : CLIMCAPSL3 DAY - NIGHT');

elseif iSmooth <= 0
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fUMBC_day.ptemptrend,100,72,64),2))); title('dT/dt : AIRS\_RT DAY');
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fUMBC_night.ptemptrend,100,72,64),2))); title('dT/dt : AIRS\_RT NIGHT');
  
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fERA5_day.ptemptrend,100,72,64),2))); title('dT/dt : ERA5 DAY');
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fERA5_night.ptemptrend,100,72,64),2))); title('dT/dt : ERA5 NIGHT');
  
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fAIRSL3_day.ptemptrend,100,72,64),2))); title('dT/dt : AIRSL3 DAY');
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fAIRSL3_night.ptemptrend,100,72,64),2))); title('dT/dt : AIRSL3 NIGHT');
  
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fCLIMCAPSL3_day.ptemptrend,100,72,64),2))); title('dT/dt : CLIMCAPSL3 DAY');
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fCLIMCAPSL3_night.ptemptrend,100,72,64),2))); title('dT/dt : CLIMCAPSL3 NIGHT');
  
  ii = ii + 1; figure(ii); clf; pcolor(rlat,plays100,squeeze(nanmean(reshape(fMERRA2.ptemptrend,100,72,64),2))); title('dT/dt : MERRA2 DAY');
  
  ii = ii + 1; figure(ii); clf; junk = squeeze(nanmean(reshape(fUMBC_day.ptemptrend + fUMBC_night.ptemptrend,100,72,64),2)); pcolor(rlat,plays100,junk/2); title('dT/dt : AIRS\_RT DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; junk = squeeze(nanmean(reshape(fERA5_day.ptemptrend + fERA5_night.ptemptrend,100,72,64),2)); pcolor(rlat,plays100,junk/2); title('dT/dt : ERA5 DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; junk = squeeze(nanmean(reshape(fAIRSL3_day.ptemptrend + fAIRSL3_night.ptemptrend,100,72,64),2)); pcolor(rlat,plays100,junk/2); title('dT/dt : AIRSL3 DAY/NIGHT');
  ii = ii + 1; figure(ii); clf; junk = squeeze(nanmean(reshape(fCLIMCAPSL3_day.ptemptrend + fCLIMCAPSL3_night.ptemptrend,100,72,64),2)); pcolor(rlat,plays100,junk/2); title('dT/dt : CLIMCAPSL3 DAY/NIGHT');
  
  ii = ii + 1; figure(ii); clf; junk = squeeze(nanmean(reshape(fUMBC_day.ptemptrend - fUMBC_night.ptemptrend,100,72,64),2)); pcolor(rlat,plays100,junk/1); title('dT/dt : AIRS\_RT DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; junk = squeeze(nanmean(reshape(fERA5_day.ptemptrend - fERA5_night.ptemptrend,100,72,64),2)); pcolor(rlat,plays100,junk/1); title('dT/dt : ERA5 DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; junk = squeeze(nanmean(reshape(fAIRSL3_day.ptemptrend - fAIRSL3_night.ptemptrend,100,72,64),2)); pcolor(rlat,plays100,junk/1); title('dT/dt : AIRSL3 DAY - NIGHT');
  ii = ii + 1; figure(ii); clf; junk = squeeze(nanmean(reshape(fCLIMCAPSL3_day.ptemptrend - fCLIMCAPSL3_night.ptemptrend,100,72,64),2)); pcolor(rlat,plays100,junk/1); title('dT/dt : CLIMCAPSL3 DAY - NIGHT');
end
...
clear newz*
  ...
  newz11 = (fUMBC_day.ptemptrend+fUMBC_night.ptemptrend)*0.5;  newz12 = (fAIRSL3_day.ptemptrend+fAIRSL3_night.ptemptrend)*0.5; newz13 = (fCLIMCAPSL3_day.ptemptrend+fCLIMCAPSL3_night.ptemptrend)*0.5;
    ...
    plotoptions2x1x2.barstr = 'dT/dt [K/yr]';
...
elseif iSmooth == 0.5
  iFig = 43; figure(iFig); clf; pcolor(rlat,plays100,smoothn(nanmean(junk,3),"movmean",5));   cx = [-1 +1]*0.151; caxis(cx); colormap(llsmap5);
  iFig = 44; figure(iFig); clf; pcolor(rlat,plays100,smoothn(nanstd(junk,[],3),"movmean",5)); cx = [0 +1]*0.031;  caxis(cx); colormap(jet);
  
  iFig = 45; figure(iFig); clf; pcolor(rlat,plays100,smoothn(moo3,"movmean",5));         cx = [0 +1];  caxis(cx); colormap(jet);
  iFig = 45; figure(iFig); clf; pcolor(rlat,plays100,moo3);                              cx = [0 +1]; caxis(cx); colormap(usa2x);
  
  iFig = 46; figure(iFig); clf; pcolor(rlat,plays100,smoothn(moo4,"movmean",5));         cx = [0 +2];       caxis(cx); colormap(usa2x);
  iFig = 46; figure(iFig); clf; pcolor(rlat,plays100,10.^moo4);                          cx = (10.^[0 +1]); caxis(cx); colormap(jett);
  
  iFig = 47; figure(iFig); clf; pcolor(rlat,plays100,smoothn(mooUMBC_num,"movmean",5));   cx = ([-1 +1]*0.15);  caxis(cx); colormap(llsmap5);
  iFig = 48; figure(iFig); clf; pcolor(rlat,plays100,smoothn(mooUMBC_denom,"movmean",5)); cx = ([0 +1]*0.15/2); caxis(cx); colormap(jet);
  iFig = 49; figure(iFig); clf; pcolor(rlat,plays100,10.^(mooUMBC));                      cx = (10.^[0 +1]);    caxis(cx); colormap(jett);
  iFig = 49; figure(iFig); clf; pcolor(rlat,plays100,mooUMBC);                            cx = ([0 +1]);        caxis(cx); colormap(jett);

elseif iSmooth <= 0
  iFig = 43; figure(iFig); clf; pcolor(rlat,plays100,nanmean(junk,3));   cx = [-1 +1]*0.151; caxis(cx); colormap(llsmap5);
  iFig = 44; figure(iFig); clf; pcolor(rlat,plays100,nanstd(junk,[],3)); cx = [0 +1]*0.031;  caxis(cx); colormap(jet);
  
  iFig = 45; figure(iFig); clf; pcolor(rlat,plays100,moo3);         cx = [0 +1];  caxis(cx); colormap(jet);
  iFig = 45; figure(iFig); clf; pcolor(rlat,plays100,moo3);         cx = [0 +1]; caxis(cx); colormap(usa2x);
  
  iFig = 46; figure(iFig); clf; pcolor(rlat,plays100,moo4);         cx = [0 +2];       caxis(cx); colormap(usa2x);
  iFig = 46; figure(iFig); clf; pcolor(rlat,plays100,10.^moo4);     cx = (10.^[0 +1]); caxis(cx); colormap(jett);
  
  iFig = 47; figure(iFig); clf; pcolor(rlat,plays100,mooUMBC_num);   cx = ([-1 +1]*0.15);  caxis(cx); colormap(llsmap5);
  iFig = 48; figure(iFig); clf; pcolor(rlat,plays100,mooUMBC_denom); cx = ([0 +1]*0.15/2); caxis(cx); colormap(jet);
  iFig = 49; figure(iFig); clf; pcolor(rlat,plays100,10.^(mooUMBC)); cx = (10.^[0 +1]);    caxis(cx); colormap(jett);
  iFig = 49; figure(iFig); clf; pcolor(rlat,plays100,mooUMBC);       cx = ([0 +1]);        caxis(cx); colormap(jett);
end
