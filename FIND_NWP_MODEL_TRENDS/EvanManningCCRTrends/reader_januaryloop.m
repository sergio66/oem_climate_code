...
for yy = 2003:2021
  iCnt = iCnt + 1;
  a=read_netcdf_lls(['/asl/s1/sergio/AIRS_L3/EVAN_MANNING_MONTHLY_CCR/stratrad_airs.cc.v7.' num2str(yy) '-01.nc']);
...
plot(a.l1b_airs.wnum,const); title('January mean BTobs');
plot(a.l1b_airs.wnum,trend); title('January trend mean BTobs');
