...
if iDorA > 0
  saver = ['save /asl/s1/sergio/AIRS_L3/airsL3_v7_native_rates_' savestr_version '_desc.mat save_olr save_clrolr save_O3 save_Q save_T save_RH save_stemp days Tlevs Qlevs latbins'];
  saver = ['save /asl/s1/sergio/AIRS_L3/airsL3_v7_native_rates_' savestr_version '_desc.mat save_* days Tlevs Qlevs latbins'];
else
  saver = ['save /asl/s1/sergio/AIRS_L3/airsL3_v7_native_rates_' savestr_version '_asc.mat save_olr save_clrolr save_O3 save_Q save_T save_RH save_stemp days Tlevs Qlevs latbins'];
