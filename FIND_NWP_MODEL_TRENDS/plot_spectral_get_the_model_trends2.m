...
figure(11); clf;
figure(11); plot(fchanx,nanmean(cosYY.*obsrates.rates,2),'k',fchanx,nanmean(cosYY.*umbcL3.umbcL3_spectral_rates,2),'g',...
...
cosYYSPolar = ones(2645,1) * cosYYSPolar;
figure(12); clf;
figure(12); plot(fchanx,nanmean(cosYYSPolar.*obsrates.rates,2),'k',fchanx,nanmean(cosYYSPolar.*umbcL3.umbcL3_spectral_rates,2),'g',...
...
cosYYNPolar = ones(2645,1) * cosYYNPolar;
figure(13); clf;
figure(13); plot(fchanx,nanmean(cosYYNPolar.*obsrates.rates,2),'k',fchanx,nanmean(cosYYNPolar.*umbcL3.umbcL3_spectral_rates,2),'g',...
