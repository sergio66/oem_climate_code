%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  %% whos allX_frac_neg0pos = 9 x 5 x 4                                       correlate ERA5 with [AIRS L3, CLIMCAPS, MERRA2, UMBC]
  %%   first index  (iY)   1 .. 9 is  1:3=200 mb RH/WV/T   4:6=500 mb RH/WV/T   7:9=500 mb RH/WV/T
  %%   'ERA5','AIRS L3','CLIMCAPS L3','MERRA2','THIS WORK' if iBiasWRT_ERA5orUMBC > 0, if iBiasWRT_ERA5orUMBC < 0 then swap UMBC, ERA5
  %%   third index  (iG)   1 .. 4 is  global,tropical,midlat,polar
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(1,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(1,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
...
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(2,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(2,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
      text(iii-0.30,jjj-0.10,junkstr,'Fontsize',7);
    end
  end
end
...
tafov(3) = nexttile;  imagesc(squeeze(allX_frac_neg0pos(3,regions,:))'); colormap(tafov(3),jet); caxis([0 1]); 
  ...
  set(gca,'xtick',[1:4],'xticklabel',znames);
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  t = title('TFRAC -0+'); t.FontSize = 10; t.FontWeight = 'normal';
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(3,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(3,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
      text(iii-0.30,jjj-0.10,junkstr,'Fontsize',7);
    end
  end
end
...
%%% 
tafov(4) = nexttile;  imagesc(squeeze(allX_frac_neg0pos(4,regions,:))'); colormap(tafov(4),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames);
  set(gca,'xtick',[1:4],'xticklabel',znames);
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  %t = title('FRAC -0+'); t.FontSize = 10; t.FontWeight = 'normal';
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(4,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(4,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
      text(iii-0.30,jjj-0.10,junkstr,'Fontsize',7);
    end
  end
end
...
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(5,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(5,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
      text(iii-0.30,jjj-0.10,junkstr,'Fontsize',7);
    end
  end
end

tafov(6) = nexttile;  imagesc(squeeze(allX_frac_neg0pos(6,regions,:))'); colormap(tafov(6),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames);
  set(gca,'xtick',[1:4],'xticklabel',znames);
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  %t = title('T'); t.FontSize = 10; t.FontWeight = 'normal';
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(6,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(6,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
      text(iii-0.30,jjj-0.10,junkstr,'Fontsize',7);
    end
  end
end
...
%%% 
tafov(7) = nexttile;  imagesc(squeeze(allX_frac_neg0pos(7,regions,:))'); colormap(tafov(7),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames);
  set(gca,'xtick',[1:4],'xticklabel',znames);
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  %t = title('FRAC -0+'); t.FontSize = 10; t.FontWeight = 'normal';
...
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(7,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(7,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
      text(iii-0.30,jjj-0.10,junkstr,'Fontsize',7);
    end
  end
end

tafov(8) = nexttile;  imagesc(squeeze(allX_frac_neg0pos(8,regions,:))'); colormap(tafov(8),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames);
  set(gca,'xtick',[1:4],'xticklabel',znames);
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  %t = title('WV'); t.FontSize = 10; t.FontWeight = 'normal';
  colorbar('southoutside');
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(8,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(8,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
      text(iii-0.30,jjj-0.10,junkstr,'Fontsize',7);
    end
  end
end

tafov(9) = nexttile;  imagesc(squeeze(allX_frac_neg0pos(9,regions,:))'); colormap(tafov(9),jet); caxis([0 1]); 
  set(gca,'ytick',[1:4],'yticklabel',mnames);
  set(gca,'xtick',[1:4],'xticklabel',znames);
  ax = gca; ax.XAxis.FontSize = 10; ax.YAxis.FontSize = 10;
  %t = title('T'); t.FontSize = 10; t.FontWeight = 'normal';
  colorbar('southoutside');
if iWriteCorrelNumbers > 0
  wah = squeeze(allX_frac_neg0pos(9,regions,:))';
  for iii = 1 : 4
    for jjj = 1 : 4
      junk = allX_frac_neg0pos(9,regions(iii),jjj); junkstr = num2str(junk,'%4.3f');
      text(iii-0.30,jjj-0.10,junkstr,'Fontsize',7);
    end
  end
end
