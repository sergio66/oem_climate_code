...
plot(fchanx,nansum(cosYY.*obsrates.rates - 0*cosYY.*obsrates.rates,2)./ncYY,'k.-',fchanx,nansum(cosYY.*obsrates.rates - cosYY.*umbcL3.umbcL3_spectral_rates,2)./ncYY,'g',...
...
plot(fchanx,nansum(cosYYPolar.*obsrates.rates - 0*cosYYPolar.*obsrates.rates,2)./ncYY,'k.-',fchanx,nansum(cosYYPolar.*obsrates.rates - cosYYPolar.*umbcL3.umbcL3_spectral_rates,2)./ncYY,'g',...
...
plot(fchanx,nansum(cosYYMidLats.*obsrates.rates - 0*cosYYMidLats.*obsrates.rates,2)./ncYY,'k.-',fchanx,nansum(cosYYMidLats.*obsrates.rates - cosYYMidLats.*umbcL3.umbcL3_spectral_rates,2)./ncYY,'g',...
...
plot(fchanx,nansum(cosYYTropics.*obsrates.rates - 0*cosYYTropics.*obsrates.rates,2)./ncYY,'k.-',fchanx,nansum(cosYYTropics.*obsrates.rates - cosYYTropics.*umbcL3.umbcL3_spectral_rates,2)./ncYY,'g',...
