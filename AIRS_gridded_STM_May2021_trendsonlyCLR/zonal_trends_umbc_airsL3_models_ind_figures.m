...
ylim([T_Ylim 1000]); ccaxis([-0.15 +0.15],0.1/100); 
  colorbar('horizontal'); colormap(cmap); title(['Zonal d/dt T UMBC Quantile' num2str(iQuantile,'%02d')]) %plotaxis2;
...
ylim([WV_Ylim 1000]); ccaxis([-0.15 +0.15],0.1/100); colorbar('horizontal'); colormap(cmap); title(['Zonal d/dt RH UMBC Quantile' num2str(iQuantile,'%02d')]) %plotaxis2;
