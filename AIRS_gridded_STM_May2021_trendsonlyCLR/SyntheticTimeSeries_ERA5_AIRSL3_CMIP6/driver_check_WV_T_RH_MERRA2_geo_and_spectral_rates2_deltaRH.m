%% this is copied and modified from driver_check_WV_T_RH_MERRA2_geo_and_spectral_rates2.m
%% this is copied and modified from driver_check_WV_T_RH_MERRA2_geo_and_spectral_rates2.m
%% this is copied and modified from driver_check_WV_T_RH_MERRA2_geo_and_spectral_rates2.m
...
%% check_all_jobs_done('/home/sergio/MATLABCODE/oem_pkg_run/AIRS_gridded_STM_May2021_trendsonlyCLR/SyntheticTimeSeries_ERA5_AIRSL3_CMIP6/STS/NIGHTorAVG/MERRA2/reconstruct_merra2_spectra_geo_rlat',64,'_2002_09_2024_08.mat');
%% check_all_jobs_done('/home/sergio/MATLABCODE/oem_pkg_run/AIRS_gridded_STM_May2021_trendsonlyCLR/SyntheticTimeSeries_ERA5_AIRSL3_CMIP6/STS/NIGHTorAVG/MERRA2/reconstruct_merra2_spectra_geo_idRH_6_rlat',64,'_2002_09_2024_08.mat');
...
%% kleenslurm; sbatch  --exclude=cnode[204,225,260,267] --array=1-64 sergio_matlab_jobB.sbatch 81     for driver_check_WV_T_RH_MERRA2_geo_and_spectral_rates2_deltaRH.m
...
YMStart = [2008 09];  YMEnd = [2022 08];  %% Ryan said they fixed O3 after 2007 so start 2008 not yet done
...
file_with_72x64_tile_retrievals = '/asl/s1/sergio/JUNK/gather_tileCLRnight_Q16_v2_unc.mat';
file_with_72x64_tile_retrievals = '/asl/s1/sergio/JUNK/gather_tileCLRnight_Q16_newERA5_2021jacs_startwith0_50fatlayers_NoMODELS_2002_2014_try1.mat';

%load /asl/s1/sergio/JUNK/gather_tileCLRnight_Q16_v2_unc.mat
wah = load(file_with_72x64_tile_retrievals,'h');
h = wah.h;
wah = load(file_with_72x64_tile_retrievals,'p');
p = wah.p;
...
kaboom = load(file_with_72x64_tile_retrievals,'rlat');
rlat = kaboom.rlat; 
...
dirout = 'STS/NIGHTorAVG/MERRA2/';
if iConstORVary == +1
  dirout = 'SimulateTimeSeries/MERRA2_ConstTracegas/';
  dirout = 'STS/NIGHTorAVG/MERRA2_ConstTracegas/';
end
