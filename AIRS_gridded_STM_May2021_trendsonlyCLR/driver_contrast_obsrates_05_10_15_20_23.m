...
disp('for more alaborate version of driver_compare_05_10_15_20_spectral_rates.m since this has far more things')
...
a.topts.dataset = 10; strUMBC = '/asl/s1/sergio/JUNK/smallgather_tileCLRnight_GULP_dataset10_Q03_newERA5_2021jacs_startwith0_50fatlayers_CarbonTrackerCO2.mat';      iNumYears = 05;  %% use CarbonTracker CO2 trends
  ...
  results05yrs = load(strUMBC,'results','resultsO3','resultsWV','resultsT');  
...
a.topts.dataset = 12; strUMBC = '/asl/s1/sergio/JUNK/smallgather_tileCLRnight_GULP_dataset12_Q03_newERA5_2021jacs_startwith0_50fatlayers_CarbonTrackerCO2.mat';      iNumYears = 15;  %% use CarbonTracker CO2 trends
  ...
  results15yrs = load(strUMBC,'results','resultsO3','resultsWV','resultsT');  
...
plotoptions.cx = [-1 +1]*0.1;  %% to see 20 year trends more clearly, will make 5 year trends look yucky
profile_plots_2x2tiledlayout(a05.h.vchan,results10yrs.rlat,z11,z12,z21,z22,15,plotoptions);

disp('Fig 16 :  avg (day+night) trends')
plotoptions.ystr = 'Latitude'; plotoptions.xstr = 'Wavenumber (cm-1)';
z11a = a05.b_desc_zonal; z12a = a10.b_desc_zonal; z21a = a15.b_desc_zonal; z22a = a20.b_desc_zonal;
z11b = a05.b_asc_zonal;  z12b = a10.b_asc_zonal;  z21b = a15.b_asc_zonal;  z22b = a20.b_asc_zonal;
z11 = 0.5*(z11a+z11b); z12 = 0.5*(z12a+z12b); z21 = 0.5*(z21a+z21b); z22 = 0.5*(z22a+z22b); 
plotoptions.cx = [-1 +1]*0.2; plotoptions.maintitle = 'dBT/dt'; plotoptions.cmap = usa2; plotoptions.yReverseDir = -1; plotoptions.yLinearOrLog = +1; plotoptions.xLimits = [640  1640]; plotoptions.yLimits = [-90 +90];
plotoptions.cx = [-1 +1]*0.1;  %% to see 20 year trends more clearly, will make 5 year trends look yucky
profile_plots_2x2tiledlayout(a05.h.vchan,results10yrs.rlat,z11,z12,z21,z22,16,plotoptions);

disp('Fig 17 :   (day-night) trends')
plotoptions.ystr = 'Latitude'; plotoptions.xstr = 'Wavenumber (cm-1)';
z11a = a05.b_desc_zonal; z12a = a10.b_desc_zonal; z21a = a15.b_desc_zonal; z22a = a20.b_desc_zonal;
z11b = a05.b_asc_zonal;  z12b = a10.b_asc_zonal;  z21b = a15.b_asc_zonal;  z22b = a20.b_asc_zonal;
z11 = (z11a-z11b); z12 = (z12a-z12b); z21 = (z21a-z21b); z22 = (z22a-z22b); 
plotoptions.cx = [-1 +1]*0.2; plotoptions.maintitle = 'dBT/dt'; plotoptions.cmap = usa2; plotoptions.yReverseDir = -1; plotoptions.yLinearOrLog = +1; plotoptions.xLimits = [640  1640]; plotoptions.yLimits = [-90 +90];
plotoptions.cx = [-1 +1]*0.025;  %% to see 20 year trends more clearly, will make 5 year trends look yucky
profile_plots_2x2tiledlayout(a05.h.vchan,results10yrs.rlat,z11,z12,z21,z22,17,plotoptions);
