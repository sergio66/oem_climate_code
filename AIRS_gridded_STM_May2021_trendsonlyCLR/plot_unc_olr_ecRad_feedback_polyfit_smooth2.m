...
strfeedbacks{ix} = 'ERA5       ';
showfeedbacks_withunc(ix,1) = junk.feedback_ecRad.planck.polyfit;
showfeedbacks_withunc(ix,2) = junk.feedback_ecRad.lapse.polyfit;
showfeedbacks_withunc(ix,3) = junk.feedback_ecRad.o3.polyfit;
showfeedbacks_withunc(ix,4) = junk.feedback_ecRad.wv.polyfit;
showfeedbacks_withunc(ix,5) = junk.feedback_ecRad.skt.polyfit;
showfeedbacks_withunc(ix,6) = junk.feedback_ecRad.ptemp_co2.polyfit;
...
tafov(1) = nexttile;
plot(xsin,smooth(era5_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),xsin,smooth(merra2_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),xsin,smooth(airsL3_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on; 
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');; 

tafov(2) = nexttile;
plot(xsin,smooth(era5_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),xsin,smooth(merra2_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),xsin,smooth(airsL3_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');
  hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','north','fontsize',8);

tafov(3) = nexttile;
plot(xsin,smooth(era5_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),xsin,smooth(merra2_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),xsin,smooth(airsL3_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');

tafov(4) = nexttile;
plot(xsin,smooth(era5_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),xsin,smooth(merra2_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),xsin,smooth(airsL3_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),...
      xsin,smooth(climcapsL3_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');
...
tafov(1) = nexttile;
plot(xsin,smooth(era5_spectral_olr.feedback_ecRad.planck.polyfit_latbin-era5_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),...
     xsin,smooth(merra2_spectral_olr.feedback_ecRad.planck.polyfit_latbin-merra2_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr.feedback_ecRad.planck.polyfit_latbin-umbc_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),...
     xsin,smooth(airsL3_spectral_olr.feedback_ecRad.planck.polyfit_latbin-airsL3_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr.feedback_ecRad.planck.polyfit_latbin-climcapsL3_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on; hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','north','fontsize',8);
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');; 

tafov(2) = nexttile;
plot(xsin,smooth(era5_spectral_olr.feedback_ecRad.lapse.polyfit_latbin-era5_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),...
     xsin,smooth(merra2_spectral_olr.feedback_ecRad.lapse.polyfit_latbin-merra2_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr.feedback_ecRad.lapse.polyfit_latbin-umbc_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),...
     xsin,smooth(airsL3_spectral_olr.feedback_ecRad.lapse.polyfit_latbin-airsL3_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr.feedback_ecRad.lapse.polyfit_latbin-climcapsL3_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');

tafov(3) = nexttile;
plot(xsin,smooth(era5_spectral_olr.feedback_ecRad.o3.polyfit_latbin-era5_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),...
     xsin,smooth(merra2_spectral_olr.feedback_ecRad.o3.polyfit_latbin-merra2_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr.feedback_ecRad.o3.polyfit_latbin-umbc_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),...
     xsin,smooth(airsL3_spectral_olr.feedback_ecRad.o3.polyfit_latbin-airsL3_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr.feedback_ecRad.o3.polyfit_latbin-climcapsL3_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');

tafov(4) = nexttile;
plot(xsin,smooth(era5_spectral_olr.feedback_ecRad.wv.polyfit_latbin-era5_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),...
     xsin,smooth(merra2_spectral_olr.feedback_ecRad.wv.polyfit_latbin-merra2_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr.feedback_ecRad.wv.polyfit_latbin-umbc_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),...
     xsin,smooth(airsL3_spectral_olr.feedback_ecRad.wv.polyfit_latbin-airsL3_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr.feedback_ecRad.wv.polyfit_latbin-climcapsL3_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');
...
boo1x = era5_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin + era5_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin + ...
       era5_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin + era5_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin;
boo2x = merra2_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin + merra2_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin + ...
       merra2_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin + merra2_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin;
boo3x = umbc_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin + umbc_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin + ...
       umbc_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin + umbc_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin;
boo4x = airsL3_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin + airsL3_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin + ...
       airsL3_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin + airsL3_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin;
boo5x = climcapsL3_spectral_olr_withunc.feedback_ecRad.planck.polyfit_latbin + climcapsL3_spectral_olr_withunc.feedback_ecRad.lapse.polyfit_latbin + ...
       climcapsL3_spectral_olr_withunc.feedback_ecRad.o3.polyfit_latbin + climcapsL3_spectral_olr_withunc.feedback_ecRad.wv.polyfit_latbin;
