...
figure(2); clf;
subplot(221); 
plot(rlat,smooth(era5_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),iSmooth),rlat,smooth(merra2_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),iSmooth),...
     rlat,smooth(umbc_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),iSmooth),rlat,smooth(airsL3_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),iSmooth),...
     rlat,smooth(climcapsL3_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),iSmooth),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('Planck'); xlim([-90 +90])

subplot(222); 
plot(rlat,smooth(era5_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),iSmooth),rlat,smooth(merra2_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),iSmooth),...
     rlat,smooth(umbc_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),iSmooth),rlat,smooth(airsL3_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),iSmooth),...
     rlat,smooth(climcapsL3_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),iSmooth),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('Lapse'); xlim([-90 +90])

subplot(223); 
plot(rlat,smooth(era5_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),iSmooth),rlat,smooth(merra2_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),iSmooth),...
     rlat,smooth(umbc_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),iSmooth),rlat,smooth(airsL3_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),iSmooth),...
     rlat,smooth(climcapsL3_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),iSmooth),'linewidth',2);
  plotaxis2; hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('Ozone'); xlim([-90 +90])

subplot(224); 
plot(rlat,smooth(era5_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),iSmooth),rlat,smooth(merra2_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),iSmooth),...
     rlat,smooth(umbc_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),iSmooth),rlat,smooth(airsL3_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),iSmooth),...
      rlat,smooth(climcapsL3_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),iSmooth),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('WV'); xlim([-90 +90])
...
figure(3); clf;
subplot(221); 
plot(rlat,smooth(era5_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),iSmooth),rlat,smooth(merra2_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),iSmooth),...
     rlat,smooth(umbc_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),iSmooth),rlat,smooth(airsL3_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),iSmooth),...
     rlat,smooth(climcapsL3_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),iSmooth),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Planck'); xlim([-90 +90])

subplot(222); 
plot(rlat,smooth(era5_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),iSmooth),rlat,smooth(merra2_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),iSmooth),...
     rlat,smooth(umbc_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),iSmooth),rlat,smooth(airsL3_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),iSmooth),...
     rlat,smooth(climcapsL3_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),iSmooth),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Lapse'); xlim([-90 +90])

subplot(223); 
plot(rlat,smooth(era5_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),iSmooth),rlat,smooth(merra2_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),iSmooth),...
     rlat,smooth(umbc_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),iSmooth),rlat,smooth(airsL3_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),iSmooth),...
     rlat,smooth(climcapsL3_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),iSmooth),'linewidth',2);
  plotaxis2; hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Ozone'); xlim([-90 +90])

subplot(224); 
plot(rlat,smooth(era5_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),iSmooth),rlat,smooth(merra2_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),iSmooth),...
     rlat,smooth(umbc_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),iSmooth),rlat,smooth(airsL3_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),iSmooth),...
      rlat,smooth(climcapsL3_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),iSmooth),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
