...
%% the value
showfeedbacks_robustfit_all(ix,1,1) = junk.feedback_ecRad.planck_ecRad_robustfit_all(1);   %% (1 == value, 2 == unc)
showfeedbacks_robustfit_all(ix,2,1) = junk.feedback_ecRad.lapse_ecRad_robustfit_all(1);
showfeedbacks_robustfit_all(ix,3,1) = junk.feedback_ecRad.o3_ecRad_robustfit_all(1);
showfeedbacks_robustfit_all(ix,4,1) = junk.feedback_ecRad.wv_ecRad_robustfit_all(1);
showfeedbacks_robustfit_all(ix,5,1) = junk.feedback_ecRad.skt_ecRad_robustfit_all(1);
showfeedbacks_robustfit_all(ix,6,1) = junk.feedback_ecRad.ptemp_co2_ecRad_robustfit_all(1);
%% the unc
showfeedbacks_robustfit_all(ix,1,2) = junk.feedback_ecRad.planck_ecRad_robustfit_all(2);   %% (1 == value, 2 == unc)
showfeedbacks_robustfit_all(ix,2,2) = junk.feedback_ecRad.lapse_ecRad_robustfit_all(2);
showfeedbacks_robustfit_all(ix,3,2) = junk.feedback_ecRad.o3_ecRad_robustfit_all(2);
showfeedbacks_robustfit_all(ix,4,2) = junk.feedback_ecRad.wv_ecRad_robustfit_all(2);
showfeedbacks_robustfit_all(ix,5,2) = junk.feedback_ecRad.skt_ecRad_robustfit_all(2);
showfeedbacks_robustfit_all(ix,6,2) = junk.feedback_ecRad.ptemp_co2_ecRad_robustfit_all(2);
...
%% the value
showfeedbacks_robustfit_all(ix,1,1) = junk.feedback_ecRad.planck_ecRad_robustfit_all(1);
showfeedbacks_robustfit_all(ix,2,1) = junk.feedback_ecRad.lapse_ecRad_robustfit_all(1);
showfeedbacks_robustfit_all(ix,3,1) = junk.feedback_ecRad.o3_ecRad_robustfit_all(1);
showfeedbacks_robustfit_all(ix,4,1) = junk.feedback_ecRad.wv_ecRad_robustfit_all(1);
showfeedbacks_robustfit_all(ix,5,1) = junk.feedback_ecRad.skt_ecRad_robustfit_all(1);
...
figure(2); clf;
subplot(221); 
plot(rlat,era5_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,1),rlat,merra2_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,1),...
     rlat,umbc_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,1),rlat,airsL3_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,1),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,1),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('Planck'); xlim([-90 +90])

subplot(222); 
plot(rlat,era5_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,1),rlat,merra2_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,1),...
     rlat,umbc_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,1),rlat,airsL3_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,1),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,1),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('Lapse'); xlim([-90 +90])

subplot(223); 
plot(rlat,era5_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,1),rlat,merra2_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,1),...
     rlat,umbc_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,1),rlat,airsL3_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,1),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,1),'linewidth',2);
  plotaxis2; hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('Ozone'); xlim([-90 +90])

subplot(224); 
plot(rlat,era5_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,1),rlat,merra2_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,1),...
     rlat,umbc_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,1),rlat,airsL3_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,1),...
      rlat,climcapsL3_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,1),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('WV'); xlim([-90 +90])
...
figure(3); clf;
subplot(221); 
plot(rlat,era5_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,2),rlat,merra2_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,2),...
     rlat,umbc_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,2),rlat,airsL3_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,2),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.planck_ecRad_robustfit_latbin(:,2),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Planck'); xlim([-90 +90])

subplot(222); 
plot(rlat,era5_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,2),rlat,merra2_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,2),...
     rlat,umbc_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,2),rlat,airsL3_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,2),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.lapse_ecRad_robustfit_latbin(:,2),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Lapse'); xlim([-90 +90])

subplot(223); 
plot(rlat,era5_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,2),rlat,merra2_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,2),...
     rlat,umbc_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,2),rlat,airsL3_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,2),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.o3_ecRad_robustfit_latbin(:,2),'linewidth',2);
  plotaxis2; hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Ozone'); xlim([-90 +90])

subplot(224); 
plot(rlat,era5_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,2),rlat,merra2_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,2),...
     rlat,umbc_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,2),rlat,airsL3_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,2),...
      rlat,climcapsL3_spectral_olr.feedback_ecRad.wv_ecRad_robustfit_latbin(:,2),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
