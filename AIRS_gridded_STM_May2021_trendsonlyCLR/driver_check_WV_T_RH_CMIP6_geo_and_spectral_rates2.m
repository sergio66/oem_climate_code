...
for ii = JOB
  ...
  p72.nlevs = ones(size(p72.rtime)) * 19;
  ...
  junk = cmip6_64x72.all.nwp_ptemp; junk = reshape(junk,numtimesteps,19,72,64); junk = squeeze(junk(:,:,:,ii)); junk = permute(junk,[2 3 1]); p72.ptemp = reshape(junk,19,72*numtimesteps);
  junk = cmip6_64x72.all.nwp_gas_1; junk = reshape(junk,numtimesteps,19,72,64); junk = squeeze(junk(:,:,:,ii)); junk = permute(junk,[2 3 1]); p72.gas_1 = reshape(junk,19,72*numtimesteps);
  %junk = cmip6_64x72.all.nwp_gas_3; junk = reshape(junk,numtimesteps,19,72,64); junk = squeeze(junk(:,:,:,ii)); junk = permute(junk,[2 3 1]); p72.gas_3 = reshape(junk,19,72*numtimesteps);
  junk = cmip6_64x72.all.nwp_rh;    junk = reshape(junk,numtimesteps,19,72,64); junk = squeeze(junk(:,:,:,ii)); junk = permute(junk,[2 3 1]); p72.rh    = reshape(junk,19,72*numtimesteps);
