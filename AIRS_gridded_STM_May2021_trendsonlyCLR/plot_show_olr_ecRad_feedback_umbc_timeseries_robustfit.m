...
figure(2); clf;
subplot(221); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),rlat,umbc10_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),...
     rlat,umbc15_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),rlat,umbc20_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1),...
     'linewidth',2);
  plotaxis2; %hl = legend('05','10','15','20','location','south','fontsize',8);
  title('Planck'); xlim([-90 +90])

subplot(222); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),rlat,umbc10_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),...
     rlat,umbc15_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),rlat,umbc20_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1),...
     'linewidth',2);
  plotaxis2; %hl = legend('05','10','15','20','location','south','fontsize',8);
  title('Lapse'); xlim([-90 +90])

subplot(223); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),rlat,umbc10_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),...
     rlat,umbc15_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),rlat,umbc20_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1),...
     'linewidth',2);
  plotaxis2; hl = legend('05','10','15','20','location','south','fontsize',8);
  title('Ozone'); xlim([-90 +90])

subplot(224); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),rlat,umbc10_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),...
     rlat,umbc15_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),rlat,umbc20_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),...
     'linewidth',2);
  plotaxis2; %hl = legend('05','10','15','20','location','south','fontsize',8);
  title('WV'); xlim([-90 +90])
...
figure(3); clf;
subplot(221); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),rlat,umbc10_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),...
     rlat,umbc15_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),rlat,umbc20_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),...
     'linewidth',2);
  plotaxis2; %hl = legend('05','10','15','20','location','south','fontsize',8);
  title('unc Planck'); xlim([-90 +90])

subplot(222); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),rlat,umbc10_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),...
     rlat,umbc15_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),rlat,umbc20_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),...
     'linewidth',2);
  plotaxis2; %hl = legend('05','10','15','20','location','south','fontsize',8);
  title('unc Lapse'); xlim([-90 +90])

subplot(223); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),rlat,umbc10_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),...
     rlat,umbc15_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),rlat,umbc20_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),...
     'linewidth',2);
  plotaxis2; hl = legend('05','10','15','20','location','south','fontsize',8);
  title('unc Ozone'); xlim([-90 +90])

subplot(224); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),rlat,umbc10_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),...
     rlat,umbc15_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),rlat,umbc20_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),...
     'linewidth',2);
  plotaxis2; %hl = legend('05','10','15','20','location','south','fontsize',8);
...
figure(5); clf;
subplot(211)
plot(rlat,umbc05_spectral_olr.feedback_ecRad.skt.robustfit_latbin(:,1),rlat,umbc10_spectral_olr.feedback_ecRad.skt.robustfit_latbin(:,1),...
     rlat,umbc15_spectral_olr.feedback_ecRad.skt.robustfit_latbin(:,1),rlat,umbc20_spectral_olr.feedback_ecRad.skt.robustfit_latbin(:,1),...
     'linewidth',2);
  xlim([-90 +90]); ylim([-3 0])
  plotaxis2; %hl = legend('05','10','15','20','location','south','fontsize',8);
  title('Skt'); 
...
subplot(212)
plot(rlat,umbc05_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1) + umbc05_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1) + ...
          umbc05_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1)     + umbc05_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),...
     rlat,umbc10_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1) + umbc10_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1) + ...
          umbc10_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1)     + umbc10_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),...
     rlat,umbc15_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1) + umbc15_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1) + ...
          umbc15_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1)     + umbc15_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),...
     rlat,umbc20_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,1) + umbc20_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,1) + ...
          umbc20_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,1)     + umbc20_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,1),...
     'linewidth',2);
  xlim([-90 +90]); ylim([-3 +3])
  plotaxis2; %hl = legend('05','10','15','20','location','south','fontsize',8);
  title('Sum Feedbacks'); 
