...
if iClearMem > 0
  px = p;
  amip6_OLR_spectral_olr.olr0       = compute_olr(h,px);
  amip6_OLR_spectral_olr.olr0_ecRad = superdriver_run_ecRad_rtp_loop_over_profiles(h,px,-1);    
        
  px = p;
  fracJUNK = fracWV; bad = find(isnan(fracJUNK)); fracJUNK(bad) = 0;
  px.gas_1 = px.gas_1 .* (1 + fracJUNK);
  amip6_OLR_spectral_olr.wv = compute_olr(h,px);
  amip6_OLR_spectral_olr.wv_ecRad = superdriver_run_ecRad_rtp_loop_over_profiles(h,px,-1);               
  figure(1); plot(h.vchan,nanmean(amip6_OLR_spectral_olr.olr0 - amip6_OLR_spectral_olr.wv,2)); title('water vapor change')
  figure(2); plot(px.rlat,amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.wv_ecRad.clr); title('water vapor change')

elseif iClearMem < 0
  amip6_OLR_spectral_olr.olr0       = amip6_spectral_olr.olr0;
  amip6_OLR_spectral_olr.olr0_ecRad = amip6_spectral_olr.olr0_ecRad;

  amip6_OLR_spectral_olr.wv         = amip6_spectral_olr.wv;
  amip6_OLR_spectral_olr.olr0_ecRad = amip6_spectral_olr.wv_ecRad;
end
...
amip6_OLR_spectral_olr.tracegas       = compute_olr(h,px);
amip6_OLR_spectral_olr.tracegas_ecRad = superdriver_run_ecRad_rtp_loop_over_profiles(h,px,-1); 
figure(1); plot(h.vchan,nanmean(amip6_OLR_spectral_olr.olr0 - amip6_OLR_spectral_olr.tracegas,2)); title('tracegas change')
figure(2); plot(px.rlat,amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.tracegas_ecRad.clr); title('tracegas change')

px = p;
fracJUNK = fracO3; bad = find(isnan(fracJUNK)); fracJUNK(bad) = 0;
px.gas_3 = px.gas_3 .* (1 + fracJUNK);
amip6_OLR_spectral_olr.o3 = compute_olr(h,px);
amip6_OLR_spectral_olr.o3_ecRad = superdriver_run_ecRad_rtp_loop_over_profiles(h,px,-1);               
figure(1); plot(h.vchan,nanmean(amip6_OLR_spectral_olr.olr0 - amip6_OLR_spectral_olr.o3,2)); title('Ozone change')
figure(2); plot(px.rlat,amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.o3_ecRad.clr); title('Ozone change')
...
amip6_OLR_spectral_olr.ptemp = compute_olr(h,px);   
amip6_OLR_spectral_olr.ptemp_ecRad = superdriver_run_ecRad_rtp_loop_over_profiles(h,px,-1);               
figure(1); plot(h.vchan,nanmean(amip6_OLR_spectral_olr.olr0 - amip6_OLR_spectral_olr.ptemp,2)); title('T(z) change')
figure(2); plot(px.rlat,amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.ptemp_ecRad.clr); title('T(z) change')
dfluxT = amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.ptemp_ecRad.clr; dfluxT(abs(dfluxT) > 2) = NaN;
...
amip6_OLR_spectral_olr.skt = compute_olr(h,px);   
amip6_OLR_spectral_olr.skt_ecRad = superdriver_run_ecRad_rtp_loop_over_profiles(h,px,-1);               
figure(1); plot(h.vchan,nanmean(amip6_OLR_spectral_olr.olr0 - amip6_OLR_spectral_olr.skt,2)); title('SST change')
figure(2); plot(px.rlat,amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.skt_ecRad.clr); title('SST change')
...
amip6_OLR_spectral_olr.ALL = compute_olr(h,px);
amip6_OLR_spectral_olr.ALL_ecRad = superdriver_run_ecRad_rtp_loop_over_profiles(h,px,-1);               
figure(1); plot(h.vchan,nanmean(amip6_OLR_spectral_olr.olr0 - amip6_OLR_spectral_olr.ALL,2)); title('ALL change')
figure(2); plot(px.rlat,amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.ALL_ecRad.clr); title('ALL change')
...
amip6_OLR_spectral_olr.ALLunc = compute_olr(h,px);
amip6_OLR_spectral_olr.ALLunc_ecRad = superdriver_run_ecRad_rtp_loop_over_profiles(h,px,-1);               
figure(1); plot(h.vchan,nanmean(amip6_OLR_spectral_olr.olr0 - amip6_OLR_spectral_olr.ALLunc,2)); title('ALLunc change')
figure(2); plot(px.rlat,amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.ALLunc_ecRad.clr); title('ALLunc change')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

olr_delta_tracegas      = amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.tracegas_ecRad.clr;
olr_delta_wv            = amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.wv_ecRad.clr;
olr_delta_o3            = amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.o3_ecRad.clr;
olr_delta_skt           = amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.skt_ecRad.clr;
olr_delta_ptemp         = amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.ptemp_ecRad.clr;
olr_delta_ALL           = amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.ALL_ecRad.clr;
olr_delta_ALLunc        = amip6_OLR_spectral_olr.olr0_ecRad.clr - amip6_OLR_spectral_olr.ALLunc_ecRad.clr;
...
plot(rlat,nanmean(reshape(olr_delta_skt,72,64),1)*iNumYears,'g',rlat,nanmean(reshape(olr_delta_ptemp,72,64),1)*iNumYears,'r',rlat,nanmean(reshape(olr_delta_wv,72,64),1)*iNumYears,'c',...
     rlat,nanmean(reshape(olr_delta_tracegas,72,64),1)*iNumYears,'m',rlat,nanmean(reshape(olr_delta_o3,72,64),1)*iNumYears,'k',rlat,nanmean(reshape(olr_delta_ALL,72,64),1)*iNumYears,'yx-','linewidth',2)
  plotaxis2; hl = legend('SKT','T(z)','WV(z)','CO2/CH4','O3','ALL','location','best','fontsize',8);
  title('AMIP6 FORCING = ORIG-NEW'); ylabel('W/m2'); xlabel('Latitude');
...
plot(rlat,-nanmean(reshape(olr_delta_ALL,72,64),1)*iNumYears,'yo-',ceres.lat,trend_ceres_lw*iNumYears,'c--',ceres.lat,trend_ceres_lw_clr*iNumYears,'b',...
  ...
  plotaxis2; hl = legend('AMIP6','CERES cld','CERES clr','AIRS L3 cld','AIRS L3 clr','location','best','fontsize',8);
...
figure(6); clf;
  ...
  hold on; errorbar(ceres.lat,trend_ceres_lw_clr*iNumYears,trend_ceres_lw_clr_err*iNumYears,'color','b','linewidth',2);
  hold off  
  plotaxis2; hl = legend('AMIP6','CERES cld','CERES clr','location','best','fontsize',8);
  title('\delta Flux = Final-Orig'); ylabel('W/m2'); xlabel('Latitude');
...
amip6_trends.rlat         = rlat;
amip6_trends.amip6_all     = -nanmean(reshape(olr_delta_ALL,72,64),1);
amip6_trends.amip6_all_err = olr_unc64;
amip6_trends.amip6_skt     = nanmean(reshape(olr_delta_skt,72,64),1);
amip6_trends.amip6_ptemp   = nanmean(reshape(olr_delta_ptemp,72,64),1);
amip6_trends.amip6_wv      = nanmean(reshape(olr_delta_wv,72,64),1);
amip6_trends.amip6_o3      = nanmean(reshape(olr_delta_o3,72,64),1);
amip6_trends.amip6_co2_ch4 = nanmean(reshape(olr_delta_tracegas,72,64),1);

outflux.ceres_trends  = ceres_trends;
outflux.airsL3_trends = airsL3_trends;
outflux.amip6_trends   = amip6_trends;
...
fprintf(1,'AMIP6    area weighted 19 year flux   cld = %8.6f clr = %8.6f W/m2 \n',[NaN  sum(cos(rlat*pi/180).*amip6_trends.amip6_all'*iNumYears)]/sum(cos(rlat*pi/180)))

%{
saveOLRname = [savename(1:end-4) '_olr_ceres_amip6.mat'];
...
figure(8); clf;  aslmap(8 ,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_tracegas,72,64)'),ns),[-90 +90],[-180 +180]);    colormap(llsmap5);  caxis([-2 2]*1.5);  title('AMIP6 OLR_{TraceGas}')
figure(9); clf;  aslmap(9 ,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_wv,72,64)'),ns),[-90 +90],[-180 +180]);          colormap(llsmap5);  caxis([-2 2]*1.5);  title('AMIP6 OLR_{Wv}')
figure(10); clf; aslmap(10,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_o3,72,64)'),ns),[-90 +90],[-180 +180]);          colormap(llsmap5);  caxis([-2 2]*1.5);  title('AMIP6 OLR_{O3}')
figure(11); clf; aslmap(11,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_skt,72,64)'),ns),[-90 +90],[-180 +180]);         colormap(llsmap5);  caxis([-2 2]*1.5);  title('AMIP6 OLR_{Skt}')
figure(12); clf; aslmap(12,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_ptemp,72,64)'),ns),[-90 +90],[-180 +180]);       colormap(llsmap5);  caxis([-2 2]*1.5);  title('AMIP6 OLR_{Ptemp}')
figure(13); clf; aslmap(13,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_ALL,72,64)'),ns),[-90 +90],[-180 +180]);         colormap(llsmap5);  caxis([-2 2]*1.5);  title('AMIP6 OLR_{ALL}')
