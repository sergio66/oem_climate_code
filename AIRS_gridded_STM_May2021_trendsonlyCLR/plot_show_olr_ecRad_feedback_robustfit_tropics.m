...
showfeedbacks_robustfit_tropics(ix,1) = junk.feedback.planck_ecRad_robustfit_tropics(1);   %% (1 == value, 2 == unc)
showfeedbacks_robustfit_tropics(ix,2) = junk.feedback.lapse_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,3) = junk.feedback.o3_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,4) = junk.feedback.wv_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,5) = junk.feedback.skt_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,6) = junk.feedback.ptemp_co2_ecRad_robustfit_tropics(1);
...
showfeedbacks_robustfit_tropics(ix,1) = junk.feedback.planck_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,2) = junk.feedback.lapse_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,3) = junk.feedback.o3_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,4) = junk.feedback.wv_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,5) = junk.feedback.skt_ecRad_robustfit_tropics(1);
...
ixx = ix;
showfeedbacks_robustfit_tropics(1:ixx,7) = sum(showfeedbacks_robustfit_tropics(1:ixx,[1 2 3 4]),2);

for ix = 1 : 5
  fprintf(1,'%s %5.2f %5.2f %5.2f %5.2f    %5.2f \n',strfeedbacks{ix},showfeedbacks_robustfit_tropics(ix,[1 2 3 4 7]));
end
trends_paper_show = showfeedbacks_robustfit_tropics(1:5,[1 2 3 4 7]);
