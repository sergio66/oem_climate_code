...
%% the value
showfeedbacks_robustfit_tropics(ix,1,1) = junk.feedback.planck_ecRad_robustfit_tropics(1);   %% (1 == value, 2 == unc)
showfeedbacks_robustfit_tropics(ix,2,1) = junk.feedback.lapse_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,3,1) = junk.feedback.o3_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,4,1) = junk.feedback.wv_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,5,1) = junk.feedback.skt_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,6,1) = junk.feedback.ptemp_co2_ecRad_robustfit_tropics(1);
%% the unc
showfeedbacks_robustfit_tropics(ix,1,2) = junk.feedback.planck_ecRad_robustfit_tropics(2);   %% (1 == value, 2 == unc)
showfeedbacks_robustfit_tropics(ix,2,2) = junk.feedback.lapse_ecRad_robustfit_tropics(2);
showfeedbacks_robustfit_tropics(ix,3,2) = junk.feedback.o3_ecRad_robustfit_tropics(2);
showfeedbacks_robustfit_tropics(ix,4,2) = junk.feedback.wv_ecRad_robustfit_tropics(2);
showfeedbacks_robustfit_tropics(ix,5,2) = junk.feedback.skt_ecRad_robustfit_tropics(2);
showfeedbacks_robustfit_tropics(ix,6,2) = junk.feedback.ptemp_co2_ecRad_robustfit_tropics(2);
...
%% the value
showfeedbacks_robustfit_tropics(ix,1,1) = junk.feedback.planck_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,2,1) = junk.feedback.lapse_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,3,1) = junk.feedback.o3_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,4,1) = junk.feedback.wv_ecRad_robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,5,1) = junk.feedback.skt_ecRad_robustfit_tropics(1);
