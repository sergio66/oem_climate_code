...
if iSave > 0
  ...
  if iHuge < 0
    ...
    fout = ['/asl/s1/sergio/JUNK/anomaly_' num2str(iQAX) '_ALL_Q' num2str(iQuant,'%02d') '_numyears_' num2str(iNumYears,'%6.2f') '_iNumAnomTimeSteps_' num2str(iNumAnomTimeSteps) '_D.mat'];
