...
showfeedbacks(ix,1) = junk.feedback_ecRad.planck.globalSST_weighted;
showfeedbacks(ix,2) = junk.feedback_ecRad.lapse.globalSST_weighted;
showfeedbacks(ix,3) = junk.feedback_ecRad.o3.globalSST_weighted;
showfeedbacks(ix,4) = junk.feedback_ecRad.wv.globalSST_weighted;
showfeedbacks(ix,5) = junk.feedback_ecRad.skt.globalSST_weighted;
showfeedbacks(ix,6) = junk.feedback_ecRad.ptemp_co2.globalSST_weighted;
