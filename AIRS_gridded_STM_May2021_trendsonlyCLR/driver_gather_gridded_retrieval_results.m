...
genericoutname = ['/asl/s1/sergio/JUNK/gather_tileCLRnight_Q16_newERA5_2021jacs_startwith' start_apriori_str '_'       numretlayers_str '_' strMODELS '_feedback.mat']; fprintf(1,' uncX1 %s \n',genericoutname);
genericoutname = ['/asl/s1/sergio/JUNK/gather_tileCLRnight_Q16_newERA5_2021jacs_startwith' start_apriori_str '_uncX3_' numretlayers_str '_' strMODELS '_feedback.mat']; fprintf(1,' uncX3 %s \n',genericoutname);
