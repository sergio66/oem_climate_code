...
strfeedbacks{ix} = 'ERA5       ';
showfeedbacks_withunc(ix,1) = junk.feedback_ecRad.planck.globalSST_weighted_all;
showfeedbacks_withunc(ix,2) = junk.feedback_ecRad.lapse.globalSST_weighted_all;
showfeedbacks_withunc(ix,3) = junk.feedback_ecRad.o3.globalSST_weighted_all;
showfeedbacks_withunc(ix,4) = junk.feedback_ecRad.wv.globalSST_weighted_all;
showfeedbacks_withunc(ix,5) = junk.feedback_ecRad.skt.globalSST_weighted_all;
showfeedbacks_withunc(ix,6) = junk.feedback_ecRad.ptemp_co2.globalSST_weighted_all;
...
%% the 6 feedbacks are feedbacks : planck lapse o3 wv skt tz/co2
%% but longwave feedback is um of first 4
disp('calcs using trends and unc')
ixx = ix;
showfeedbacks_withunc(1:ixx,7) = sum(showfeedbacks_withunc(1:ixx,[1 2 3 4]),2);

for ix = 1 : 5
  fprintf(1,'%s %5.2f %5.2f %5.2f %5.2f    %5.2f \n',strfeedbacks{ix},showfeedbacks_withunc(ix,[1 2 3 4 7]));
end
...
tafov(1) = nexttile;
plot(xsin,smooth(era5_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),xsin,smooth(merra2_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),xsin,smooth(airsL3_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on; 
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');; 

tafov(2) = nexttile;
plot(xsin,smooth(era5_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),xsin,smooth(merra2_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),xsin,smooth(airsL3_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');
  hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','north','fontsize',8);

tafov(3) = nexttile;
plot(xsin,smooth(era5_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),xsin,smooth(merra2_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),xsin,smooth(airsL3_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');

tafov(4) = nexttile;
plot(xsin,smooth(era5_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),xsin,smooth(merra2_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),xsin,smooth(airsL3_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),...
      xsin,smooth(climcapsL3_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');
...
tafov(1) = nexttile;
plot(xsin,smooth(era5_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin-era5_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(merra2_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin-merra2_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin-umbc_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(airsL3_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin-airsL3_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin-climcapsL3_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on; hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','north','fontsize',8);
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');; 

tafov(2) = nexttile;
plot(xsin,smooth(era5_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin-era5_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(merra2_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin-merra2_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin-umbc_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(airsL3_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin-airsL3_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin-climcapsL3_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');

tafov(3) = nexttile;
plot(xsin,smooth(era5_spectral_olr.feedback_ecRad.o3.globalSST_weighted_latbin-era5_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(merra2_spectral_olr.feedback_ecRad.o3.globalSST_weighted_latbin-merra2_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr.feedback_ecRad.o3.globalSST_weighted_latbin-umbc_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(airsL3_spectral_olr.feedback_ecRad.o3.globalSST_weighted_latbin-airsL3_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr.feedback_ecRad.o3.globalSST_weighted_latbin-climcapsL3_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');

tafov(4) = nexttile;
plot(xsin,smooth(era5_spectral_olr.feedback_ecRad.wv.globalSST_weighted_latbin-era5_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(merra2_spectral_olr.feedback_ecRad.wv.globalSST_weighted_latbin-merra2_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(umbc_spectral_olr.feedback_ecRad.wv.globalSST_weighted_latbin-umbc_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(airsL3_spectral_olr.feedback_ecRad.wv.globalSST_weighted_latbin-airsL3_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),...
     xsin,smooth(climcapsL3_spectral_olr.feedback_ecRad.wv.globalSST_weighted_latbin-climcapsL3_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin,iSmooth),'linewidth',2);
  plotaxis2; box on;
  xlim([-1 +1]); set(gca,'XTick',xtick,'XTickLabel',xticklab,'TickLabelInterpreter','tex');
...
boo1x = era5_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin + era5_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin + ...
       era5_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin + era5_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin;
boo2x = merra2_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin + merra2_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin + ...
       merra2_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin + merra2_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin;
boo3x = umbc_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin + umbc_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin + ...
       umbc_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin + umbc_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin;
boo4x = airsL3_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin + airsL3_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin + ...
       airsL3_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin + airsL3_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin;
boo5x = climcapsL3_spectral_olr_withunc.feedback_ecRad.planck.globalSST_weighted_latbin + climcapsL3_spectral_olr_withunc.feedback_ecRad.lapse.globalSST_weighted_latbin + ...
       climcapsL3_spectral_olr_withunc.feedback_ecRad.o3.globalSST_weighted_latbin + climcapsL3_spectral_olr_withunc.feedback_ecRad.wv.globalSST_weighted_latbin;
...
figure(6); xlabel('Latitude'); ylabel('\lambda = \Sigma_{i} \lambda_{i}','interpreter','tex'); ylim([-1 +1]*2.5); ylim([-6 +6])
figure(7); xlabel('Latitude'); ylabel('\lambda = \Sigma_{i} \lambda_{i}','interpreter','tex'); ylim([-1 +1]*2.5); ylim([-6 +6])
figure(8); xlabel('Latitude'); ylabel('\lambda = \Sigma_{i} \lambda_{i}','interpreter','tex'); ylim([-1 +1]*2.0);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

figure(9); 
  plot(era5_spectral_olr.feedback_ecRad.savenums,era5_spectral_olr.feedback_ecRad.savenums,'b.',...
       era5_spectral_olr.feedback_ecRad.savenums,era5_spectral_olr_withunc.feedback_ecRad.savenums,'r.')

  plot(era5_spectral_olr.feedback_ecRad.savenums(1,:)-era5_spectral_olr.feedback_ecRad.savenums(2,:),...
       era5_spectral_olr.feedback_ecRad.savenums(1,:)-era5_spectral_olr.feedback_ecRad.savenums(2,:),'b.',...
       era5_spectral_olr.feedback_ecRad.savenums(1,:)-era5_spectral_olr.feedback_ecRad.savenums(2,:),...
       era5_spectral_olr_withunc.feedback_ecRad.savenums(1,:)-era5_spectral_olr_withunc.feedback_ecRad.savenums(2,:),'r.')

  for ii = 1 : 6
    plot(era5_spectral_olr.feedback_ecRad.savenums(ii,:),era5_spectral_olr.feedback_ecRad.savenums(ii,:),'b.',...
         era5_spectral_olr.feedback_ecRad.savenums(ii,:),era5_spectral_olr_withunc.feedback_ecRad.savenums(ii,:),'r.')
    xlabel('with trends only'); ylabel('trends+unc'); plotaxis2; title(num2str(ii)); pause(1)
  end
