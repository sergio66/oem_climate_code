...
if isfield(fERA5_night,'frac_e2m')
  ...
  deltaILR_ERA5_from_actual_monthly_trends = compute_ILR_rate_Bruntsaert(eair_ERA5,Tx2m_ERA5,fERA5_night.frac_e2m,fERA5_night.t2m);
...
[deltaILR_ERA5,ILR_ERA5] = compute_ILR_rate_Bruntsaert(eair_ERA5,Tx2m_ERA5,dWVsurf_ERA5,dTx2m_ERA5);
...
clf; plot(rlat,nanmean(reshape(deltaILR_ERA5,72,64),1),'b',ceres_ilr.ceres_trend.trend_lat,ceres_ilr.ceres_trend.trend_lw_clr,'r','linewidth',2);
  ...
  hl = legend('ERA5 Brutsaert','CERES','location','best','fontsize',10);
...
if isfield(fERA5_night,'frac_e2m')
  clf; plot(rlat,nanmean(reshape(deltaILR_ERA5,72,64),1),'b',rlat,nanmean(reshape(deltaILR_ERA5_from_actual_monthly_trends,72,64),1),'co-',...
    ...
    title('\deltaILR (W/m2) from Brutsaert'); plotaxis2;
    hl = legend('ERA5 Brutsaert','ERA5 Brutsaert from actual monthly trends','CERES','location','best','fontsize',10);
end
