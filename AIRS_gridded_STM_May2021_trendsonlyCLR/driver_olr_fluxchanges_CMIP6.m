...
%{
saveOLRname = [savename(1:end-4) '_olr_ceres_CMIP6.mat'];
...
figure(8); clf;  aslmap(8 ,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_tracegas,72,64)'),ns),[-90 +90],[-180 +180]);    colormap(llsmap5);  caxis([-2 2]*1.5);  title('CMIP6 OLR_{TraceGas}')
figure(9); clf;  aslmap(9 ,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_wv,72,64)'),ns),[-90 +90],[-180 +180]);          colormap(llsmap5);  caxis([-2 2]*1.5);  title('CMIP6 OLR_{Wv}')
figure(10); clf; aslmap(10,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_o3,72,64)'),ns),[-90 +90],[-180 +180]);          colormap(llsmap5);  caxis([-2 2]*1.5);  title('CMIP6 OLR_{O3}')
figure(11); clf; aslmap(11,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_skt,72,64)'),ns),[-90 +90],[-180 +180]);         colormap(llsmap5);  caxis([-2 2]*1.5);  title('CMIP6 OLR_{Skt}')
figure(12); clf; aslmap(12,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_ptemp,72,64)'),ns),[-90 +90],[-180 +180]);       colormap(llsmap5);  caxis([-2 2]*1.5);  title('CMIP6 OLR_{Ptemp}')
figure(13); clf; aslmap(13,rlat65,rlon73,-iNumYears*smoothn((reshape(olr_delta_ALL,72,64)'),ns),[-90 +90],[-180 +180]);         colormap(llsmap5);  caxis([-2 2]*1.5);  title('CMIP6 OLR_{ALL}')
