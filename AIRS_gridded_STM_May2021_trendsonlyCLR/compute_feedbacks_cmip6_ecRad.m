...
indSST    = cmip6.trend_stemp;
globalSST = nanmean(cmip6.trend_stemp);
...
px = p;
%px.gas_2 = px.gas_2*(1+2.2/400);
fracJUNK = cmip6.trend_gas_1(1:100,:); bad = find(isnan(fracJUNK)); fracJUNK(bad) = 0;
if iLambda_UseGlobalSST == -1
...
if iLambda_UseGlobalSST == -1
  ...
  cmip6_spectral_olr.feedback.skt_ecRad = -cmip6_spectral_olr.feedback.skt_ecRad/globalSST;
end
