...
%% the value
showfeedbacks_robustfit_midlats(ix,1,1) = junk.feedback_ecRad.planck_ecRad_robustfit_midlats(1);   %% (1 == value, 2 == unc)
showfeedbacks_robustfit_midlats(ix,2,1) = junk.feedback_ecRad.lapse_ecRad_robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,3,1) = junk.feedback_ecRad.o3_ecRad_robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,4,1) = junk.feedback_ecRad.wv_ecRad_robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,5,1) = junk.feedback_ecRad.skt_ecRad_robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,6,1) = junk.feedback_ecRad.ptemp_co2_ecRad_robustfit_midlats(1);
%% the unc
showfeedbacks_robustfit_midlats(ix,1,2) = junk.feedback_ecRad.planck_ecRad_robustfit_midlats(2);   %% (1 == value, 2 == unc)
showfeedbacks_robustfit_midlats(ix,2,2) = junk.feedback_ecRad.lapse_ecRad_robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,3,2) = junk.feedback_ecRad.o3_ecRad_robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,4,2) = junk.feedback_ecRad.wv_ecRad_robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,5,2) = junk.feedback_ecRad.skt_ecRad_robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,6,2) = junk.feedback_ecRad.ptemp_co2_ecRad_robustfit_midlats(2);
...
%% the value
showfeedbacks_robustfit_midlats(ix,1,1) = junk.feedback_ecRad.planck_ecRad_robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,2,1) = junk.feedback_ecRad.lapse_ecRad_robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,3,1) = junk.feedback_ecRad.o3_ecRad_robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,4,1) = junk.feedback_ecRad.wv_ecRad_robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,5,1) = junk.feedback_ecRad.skt_ecRad_robustfit_midlats(1);
