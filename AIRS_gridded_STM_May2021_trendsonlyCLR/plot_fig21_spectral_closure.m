...
tafov(1) = nexttile;
plot(f,airsobs,'b',f,nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc0.umbc_spectral_rates'),'r',...
...
tafov(2) = nexttile;
plot(f,airsobs,'b',f,nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc0.airsL3_spectral_rates'),'r',...
...
tafov(3) = nexttile;
plot(f,airsobs,'b',f,nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc0.era5_spectral_rates'),'r',...
...
tafov(4) = nexttile;
plot(f,airsobs,'b',f,nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc0.cmip6_spectral_rates'),'r',...
...
plot(f,airsobs,f,airsobs_unc,...
     f,abs((nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc_Perror.umbc_spectral_rates')-nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc0.umbc_spectral_rates'))),...
     f,abs((nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc_Perror.airsL3_spectral_rates')-nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc0.airsL3_spectral_rates'))),...
     f,abs((nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc_Perror.era5_spectral_rates')-nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc0.era5_spectral_rates'))),...
     f,abs((nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc_Perror.cmip6_spectral_rates')-nanmean(nwp_spectral_trends_cmip6_era5_airsL3_umbc0.cmip6_spectral_rates'))),...
     'linewidth',0.5)
...
figure(21); figname = 'spectral_plot_with_unc_64x72.pdf';  figure(21); aslprint(figname)
figure(22); figname = 'spectral_plot_with_unc2_64x72.pdf'; figure(22); aslprint(figname)
