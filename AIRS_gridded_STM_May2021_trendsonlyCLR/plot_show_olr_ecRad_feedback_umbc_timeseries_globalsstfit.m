...
figure(2); clf;
subplot(221); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin,rlat,factor*umbc10_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin,'x-',...
...
subplot(222); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin,rlat,factor*umbc10_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin,'x-',...
...
subplot(223); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.o3.globalSST_weighted_latbin,rlat,factor*umbc10_spectral_olr.feedback_ecRad.o3.globalSST_weighted_latbin,'x-',...
...
subplot(224); 
plot(rlat,umbc05_spectral_olr.feedback_ecRad.wv.globalSST_weighted_latbin,rlat,factor*umbc10_spectral_olr.feedback_ecRad.wv.globalSST_weighted_latbin,'x-',...
...
figure(5); clf;
subplot(211)
plot(rlat,umbc05_spectral_olr.feedback_ecRad.skt.globalSST_weighted_latbin,rlat,factor*umbc10_spectral_olr.feedback_ecRad.skt.globalSST_weighted_latbin,'x-',...
...
plot(rlat,umbc05_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin + umbc05_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin + ...
     ...
     rlat,factor*umbc10_spectral_olr.feedback_ecRad.planck.globalSST_weighted_latbin + factor*umbc10_spectral_olr.feedback_ecRad.lapse.globalSST_weighted_latbin + ...
          factor*umbc10_spectral_olr.feedback_ecRad.o3.globalSST_weighted_latbin     + factor*umbc10_spectral_olr.feedback_ecRad.wv.globalSST_weighted_latbin,'x-',...
