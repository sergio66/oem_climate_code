...
if driver.i16daytimestep < 0
  ...
  switch driver.rateset.ocb_set
    ...
    case {'obs','tracegas'}
     ...
     if driver.NorD > 0 
       driver.rateset.rates = real(trends.dbt_desc(:,driver.iQuantile));
     elseif driver.NorD < 0 
       driver.rateset.rates = real(trends.dbt_asc(:,driver.iQuantile));
     end
    ...
    if iNnoise < 0 
      if driver.NorD > 0
        driver.rateset.unc_rates = real(trends.dbt_err_desc(:,driver.iQuantile));
      elseif driver.NorD < 0
        driver.rateset.unc_rates = real(trends.dbt_err_asc(:,driver.iQuantile));
      end
    else
