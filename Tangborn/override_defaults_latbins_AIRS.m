...
smoothVSregularization='c'; 
  ...
  %% Latitude dependent standard deviations. 
     ...
     TS(1:36)=2.0;  TS(36)=3.0;  TS(35)=3.0; TS(34)=3.0; TS(32)=2.0;      
     % Upper troposphere temperature
     TUT(1:36)=2.0; TUT(36)=3.0; TUT(35)=3.0; TUT(34)=3.0; TUT(32)=0.8;                    % Temp Upper Trop 
     TLT(1:36)=2.0; TLT(36)=3.0; TLT(35)=5.0; TLT(34)=1.0; TLT(32)=0.5;   
     WVS(1:36)=1.0; WVS(36)=0.5; WVS(35)=0.5; WVS(34)=0.5; WVS(32)=2.0;  
     WVT(1:36)=1.0; WVT(36)=0.3; WVT(35)=0.3; WVT(34)=0.3; WVT(32)=0.1 
     CO2(1:36)=1.0; CO2(36)=1.0; CO2(35)=1.0; CO2(34)=1.0; CO2(32)=5.0; 
     O3(1:36)=1.0;  O3(36)=1.0;  O3(35)=1.0;  O3(34)=1.0; O3(32)=2.0; 
     N2O(1:36)=1.0; N2O(36)=1.0; N2O(35)=1.0; N2O(34)=1.0; N20(32)=2.0;  
     CH4(1:36)=1.0; CH5(36)=1.0; CH5(35)=1.0; CH5(34)=1.0; CH5(32)=2.0; 
     CFC11(1:36)=1.0; 
     STEMP(1:36)=1.0; STEMP(36)=0.1; STEMP(35)=0.1; STEMP(34)=0.1; STEMP(32) = 3.0;  
     C_L(1:36) = 1.5; C_L(36)=2.1; C_L(35)=1.8; C_L(32) = 2.2;  
