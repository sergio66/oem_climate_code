...
covariance_tuning='prof'
 ...
 if covariance_tuning=='prof'
  %% Latitude dependent standard deviations. 
     ...
     TS(1:36)=2.0;  TS(36)=1.0;  TS(35)=1.0; TS(34)=1.0; TS(33)=0.7; TS(32)=1.0; TS(31)=1.0; TS(30)=1.0; TS(29)=0.8; TS(28)=0.5; TS(27)=0.5; TS(26)=0.5; TS(25)=0.5; TS(24)=0.5; TS(23)=0.5; TS(22)=0.5; TS(21)=0.5; TS(20)=0.5; TS(19)=0.5; TS(18)=1.0; TS(17)=1.0; TS(16)=1.0; TS(15)=1.0; TS(14)=1.0; TS(13)=1.0; TS(12)=1.0; TS(11)=1.0; TS(10)=1.0; TS(9)=1.5; TS(8)=2.5; TS(7)=2.5; TS(6)=2.1; TS(5)=1.0; TS(4)=1.5; TS(3)=1.2; TS(2)=1.0; TS(1)=2.0;              
