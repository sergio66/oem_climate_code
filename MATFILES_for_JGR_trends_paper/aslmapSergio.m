% cp /umbc/xfs2/strow/asl/matlib/maps/aslmap.m aslmapSergio.m
% NAME
%   aslmap - global map for equal area trapezoids
%
% SYNOPSIS
%   fh = equal_area_map(glat, glon, gval, latlim, lonlim, opts)
%
% INPUTS
...
% DISCUSSION
%
function fh = aslmapSergio(glat, glon, gval, latlim, lonlim, varargin);
