ix = driver.iibin;
    dd = load('airs_chanlist_calib_tomp');
...
load Data/airsL3_v6_rates_stats_Feb2016_13yr.mat
...
for i=1:97 
   ...
   for j=1:97 
      ...
      sum_ozone = sum_ozone+driver.oem.ak_ozone(j,i);       
   end 
   for j=1:97
      ak_water(j,i) = driver.oem.ak_water(j,i);%/sum_water; 
      ak_temp(j,i)  = driver.oem.ak_temp(j,i);%/sum_temp;
      ak_ozone(j,i) = driver.oem.ak_ozone(j,i);%/sum_ozone;       
   end 
end 
