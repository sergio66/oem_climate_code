...
%% the value
showfeedbacks_robustfit_tropics(ix,1,1) = junk.umbc_spectral_olr.feedback_ecRad.planck.robustfit_tropics(1);  %% (1 == value, 2 == unc)
showfeedbacks_robustfit_tropics(ix,2,1) = junk.umbc_spectral_olr.feedback_ecRad.lapse.robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,3,1) = junk.umbc_spectral_olr.feedback_ecRad.o3.robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,4,1) = junk.umbc_spectral_olr.feedback_ecRad.wv.robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,5,1) = junk.umbc_spectral_olr.feedback_ecRad.skt.robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,6,1) = junk.umbc_spectral_olr.feedback_ecRad.ptemp_co2.robustfit_tropics(1);
%% the unc
showfeedbacks_robustfit_tropics(ix,1,2) = junk.umbc_spectral_olr.feedback_ecRad.planck.robustfit_tropics(2); 
showfeedbacks_robustfit_tropics(ix,2,2) = junk.umbc_spectral_olr.feedback_ecRad.lapse.robustfit_tropics(2);
showfeedbacks_robustfit_tropics(ix,3,2) = junk.umbc_spectral_olr.feedback_ecRad.o3.robustfit_tropics(2);
showfeedbacks_robustfit_tropics(ix,4,2) = junk.umbc_spectral_olr.feedback_ecRad.wv.robustfit_tropics(2);
showfeedbacks_robustfit_tropics(ix,5,2) = junk.umbc_spectral_olr.feedback_ecRad.skt.robustfit_tropics(2);
showfeedbacks_robustfit_tropics(ix,6,2) = junk.umbc_spectral_olr.feedback_ecRad.ptemp_co2.robustfit_tropics(2);
...
%% the value
showfeedbacks_robustfit_tropics(ix,1,1) = junk.umbc_spectral_olr.feedback_ecRad.planck.robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,2,1) = junk.umbc_spectral_olr.feedback_ecRad.lapse.robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,3,1) = junk.umbc_spectral_olr.feedback_ecRad.o3.robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,4,1) = junk.umbc_spectral_olr.feedback_ecRad.wv.robustfit_tropics(1);
showfeedbacks_robustfit_tropics(ix,5,1) = junk.umbc_spectral_olr.feedback_ecRad.skt.robustfit_tropics(1);
