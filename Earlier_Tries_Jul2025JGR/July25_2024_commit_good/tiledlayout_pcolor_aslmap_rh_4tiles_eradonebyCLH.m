...
era    = load('/home/sergio/MATLABCODE/oem_pkg_run/AIRS_gridded_May2021_anomalyonlyCLR/era_rh_zonal_trends_donebyCLH.mat');
...
%% aslprint
%% aslprint_asis('/home/sergio/PAPERS/AIRS/AIRS-STM-May-2021/tiletrends/Figs/all_zonal_rh_trends_eradonebyCLH.pdf');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
...
%% aslprint
%% aslprint_asis('/home/sergio/PAPERS/AIRS/AIRS-STM-May-2021/tiletrends/Figs/all_global_rh_500mb_eradonebyCLH.pdf');
