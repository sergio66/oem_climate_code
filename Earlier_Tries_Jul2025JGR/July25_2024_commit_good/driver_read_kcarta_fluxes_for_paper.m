...
if iReadSave_Or_MakePlots > 0
  ...
  disp('already read in calcs, made convolutions ... now look at results')
end
...
if iReadSave_Or_MakePlots > 0
  ...
  figure(1); clf; plot(fc,nanmean((radF-rad0).*cosFIR_ThIR,2),h.vchan,moo); ylabel('\delta Rad coswgt')
