...
elseif abs(settings.dataset) >= 1 & abs(settings.dataset) <= 15
  ...
  elseif settings.descORasc == +1 & driver.i16daytimestep < 0 & (settings.dataset >= 9 & settings.dataset <= 12)
    ...
    elseif settings.ocb_set == +1  & driver.i16daytimestep < 0
      driver.rateset.datafile  = 'convert_strowrates2oemrates_allskygrid_obsNcalcsAHAH.mat';           
      driver.rateset.datafile  = 'AHAH';
      driver.rateset.datafile  = ['/home/sergio/git/oem_climate_code/AIRS_gridded_STM_May2021_trendsonlyCLR/SyntheticTimeSeries_ERA5_AIRSL3_CMIP6/STS/NIGHTorAVG/ERA5//20yrs/ERA5_spectraltrends_2002_09_2022_08.mat'];      
