...
%% the value
showfeedbacks_robustfit_midlats(ix,1,1) = junk.umbc_spectral_olr.feedback_ecRad.planck.robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,2,1) = junk.umbc_spectral_olr.feedback_ecRad.lapse.robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,3,1) = junk.umbc_spectral_olr.feedback_ecRad.o3.robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,4,1) = junk.umbc_spectral_olr.feedback_ecRad.wv.robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,5,1) = junk.umbc_spectral_olr.feedback_ecRad.skt.robustfit_midlats(1);
showfeedbacks_robustfit_midlats(ix,6,1) = junk.umbc_spectral_olr.feedback_ecRad.ptemp_co2.robustfit_midlats(1);
%% the unc
showfeedbacks_robustfit_midlats(ix,1,2) = junk.umbc_spectral_olr.feedback_ecRad.planck.robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,2,2) = junk.umbc_spectral_olr.feedback_ecRad.lapse.robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,3,2) = junk.umbc_spectral_olr.feedback_ecRad.o3.robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,4,2) = junk.umbc_spectral_olr.feedback_ecRad.wv.robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,5,2) = junk.umbc_spectral_olr.feedback_ecRad.skt.robustfit_midlats(2);
showfeedbacks_robustfit_midlats(ix,6,2) = junk.umbc_spectral_olr.feedback_ecRad.ptemp_co2.robustfit_midlats(2);
...
trends_paper_show = showfeedbacks_robustfit_midlats(1:ixx,[1 2 3 4 7]);
