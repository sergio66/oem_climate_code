...
%boo = load('/home/sergio/git/oem_climate_code/AIRS_gridded_STM_May2021_trendsonlyCLR/SyntheticTimeSeries_ERA5_AIRSL3_CMIP6/STS/NIGHTorAVG/ERA5//20yrs/ERA5_spectraltrends_2002_09_2022_08.mat');
%pcolor(reshape(boo.era5_rates_desc(1520,:),72,64)'); shading interp; colorbar; colormap(usa2); caxis([-1 +1]*0.15)
%plot(1:2645,driver.rateset.rates,1:2645,boo.era5_rates_desc(:,driver.iibin)); title(num2str(driver.iibin))
