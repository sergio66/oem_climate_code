...
tafov(1) = nexttile;
contour(double(umbc.rlat),double(umbc.p97(1:96)),double(umbc.data(1:96,:)));  %title('UMBC','Fontsize',12); 
line([-90 +90],[125 125],'color','k','linewidth',2);

tafov(2) = nexttile;
contour(double(airsL3.rlat),double(airsL3.hlevs),double(airsL3.data)); %title('AIRSL3','Fontsize',12);
line([-90 +90],[125 125],'color','k','linewidth',2);

tafov(3) = nexttile;
contour(double(era.rlat),double(era.plays),double(era.data)); %title('ERA','Fontsize',12); 
line([-90 +90],[125 125],'color','k','linewidth',2);
...
%% aslprint
%% aslprint_asis('/home/sergio/PAPERS/AIRS/AIRS-STM-May-2021/tiletrends/Figs/all_zonal_rh_trends_linear_contour.pdf');
...
giss   = nanmean(giss.giss_trend4608,1);
umbc   = load('/home/sergio/MATLABCODE/oem_pkg_run/AIRS_gridded_May2021_trendsonlyCLR/umbc_RH_zonal_trends.mat');
airsL3 = load('/home/sergio/MATLABCODE/oem_pkg_run/AIRS_gridded_May2021_anomalyonlyCLR/airsL3_rh_zonal_trends.mat');
era    = load('/home/sergio/MATLABCODE/oem_pkg_run/AIRS_gridded_May2021_anomalyonlyCLR/era_rh_zonal_trends.mat');
...
tafov(1) = nexttile;
pcolor(double(umbc.rlat),double(umbc.p97(1:96)),double(umbc.data(1:96,:)./(ones(96,1)*giss)));  %title('UMBC','Fontsize',12); 
line([-90 +90],[125 125],'color','k','linewidth',2);
shading interp

tafov(2) = nexttile;
pcolor(double(airsL3.rlat),double(airsL3.hlevs),double(airsL3.data./(ones(12,1)*giss))); %title('AIRSL3','Fontsize',12);
line([-90 +90],[125 125],'color','k','linewidth',2);
shading interp

tafov(3) = nexttile;
pcolor(double(era.rlat),double(era.plays),double(era.data./(ones(100,1)*giss))); %title('ERA','Fontsize',12); 
line([-90 +90],[125 125],'color','k','linewidth',2);
shading interp
...
%% aslprint
%% aslprint_asis('/home/sergio/PAPERS/AIRS/AIRS-STM-May-2021/tiletrends/Figs/all_zonal_rh_trends_per_K_sst.pdf');
...
tafov(1) = nexttile;
contour_solid_dashed(double(umbc.rlat),double(umbc.p97(1:96)),double(umbc.data(1:96,:)));  %title('UMBC','Fontsize',12); 
line([-90 +90],[125 125],'color','k','linewidth',2);

tafov(2) = nexttile;
contour_solid_dashed(double(airsL3.rlat),double(airsL3.hlevs),double(airsL3.data)); %title('AIRSL3','Fontsize',12);
line([-90 +90],[125 125],'color','k','linewidth',2);

tafov(3) = nexttile;
contour_solid_dashed(double(era.rlat),double(era.plays),double(era.data)); %title('ERA','Fontsize',12); 
line([-90 +90],[125 125],'color','k','linewidth',2);
...
%% aslprint
%% aslprint_asis('/home/sergio/PAPERS/AIRS/AIRS-STM-May-2021/tiletrends/Figs/all_zonal_rh_trends_linear_contour_solid_dashed.pdf');
