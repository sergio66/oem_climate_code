...
figure(3); clf;
subplot(221); 
plot(rlat,era5_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),rlat,merra2_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),...
     rlat,umbc_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),rlat,airsL3_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.planck.robustfit_latbin(:,2),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Planck'); xlim([-90 +90])

subplot(222); 
plot(rlat,era5_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),rlat,merra2_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),...
     rlat,umbc_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),rlat,airsL3_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.lapse.robustfit_latbin(:,2),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Lapse'); xlim([-90 +90])

subplot(223); 
plot(rlat,era5_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),rlat,merra2_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),...
     rlat,umbc_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),rlat,airsL3_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),...
     rlat,climcapsL3_spectral_olr.feedback_ecRad.o3.robustfit_latbin(:,2),'linewidth',2);
  plotaxis2; hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
  title('unc Ozone'); xlim([-90 +90])

subplot(224); 
plot(rlat,era5_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),rlat,merra2_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),...
     rlat,umbc_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),rlat,airsL3_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),...
      rlat,climcapsL3_spectral_olr.feedback_ecRad.wv.robustfit_latbin(:,2),'linewidth',2);
  plotaxis2; %hl = legend('ERA5','MERRA2','THIS WORK','AIRS L3','CLIMCAPS L3','location','south','fontsize',8);
