...
for ix = 1 : 40
  ...
  fname1 = ['/home/strow/Work/Airs/Stability/Data/Asc_fits/Small/fit_nucal_robs_lat' num2str(ix) '.mat'];
  fname2 = ['/home/strow/Work/Airs/Stability/Data/Asc_fits/Small/fit_rclr_lat' num2str(ix) '.mat'];
  fname3 = ['/home/strow/Work/Airs/Stability/Data/Asc_fits/Small/fit_bias_lat' num2str(ix) '.mat'];
...
comment = 'from /home/strow/Work/Airs/Stability/Data/Asc_fits/Small Feb 26, 2019 and convert_strowrates2oemrates_clr2_asc.m';
save convert_strowrates2oemrates_random_16_year_v32_clearasc_nucal.mat  b_* comment lagcor*
