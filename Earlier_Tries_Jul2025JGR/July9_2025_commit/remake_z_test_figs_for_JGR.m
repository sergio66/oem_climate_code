...
figure(169); set(gca,'fontsize',sizefont); text(-80,20, '(A)','fontsize',12); caxis([0 0.015]);
figure(170); set(gca,'fontsize',sizefont); text(-80,200,'(C)','fontsize',12); caxis([0 2e-3]);
figure(186); text(-105,6000,'K/yr','fontsize',12);; set(gca,'fontsize',sizefont); text(-80,20, '(B)','fontsize',12);  
figure(190); text(-105,1350,'1/yr');set(gca,'fontsize',sizefont); text(-80,200,'(D)','fontsize',12);  
