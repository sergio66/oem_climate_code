...
if iLoad == 1
  ...
  %load('/home/sergio/MATLABCODE/oem_pkg_run_sergio_AuxJacs/MakeProfs/CLO_LAT40_avg_made_Dec2019_Clr/Desc/16DayAvgNoS/all_latbins_rates.mat'); 
end
...
if iLoad > 0
  ...
  ak = eye(size(driver.oem.ak_water));
end
...
if iLoad > 0
  ...
  ak = eye(size(driver.oem.ak_temp));
end
...
if iLoad > 0
  ...
  ak = eye(size(driver.oem.ak_ozone));
end
