...
for iLatbin = iLS : iLE
  ...
  if i_obsORcal > 0
    ...
    fname = ['/home/sergio/MATLABCODE/QUICKTASKS_TELECON/AIRS2CRIS_and_IASI2CRIS/sergio_airs2cris_decon/SergioRates/Desc_ocean_fits/fit_robs_lat' num2str(iLatbin) '.mat'];
  else
    fname = ['/home/strow/Work/Cris/Stability/Data/Desc_fits/fit_rclr_lat' num2str(iLatbin) '.mat'];
    fname = ['/home/sergio/MATLABCODE/QUICKTASKS_TELECON/AIRS2CRIS_and_IASI2CRIS/sergio_airs2cris_decon/SergioRates/Desc_ocean_fits/fit_rclr_lat' num2str(iLatbin) '.mat'];
  end
  a = load(fname);
  ...
  for iChan = 1 : 1305
    ...
    data(iB) = interp1(days_since_2012,data(iA),missingdays);
    ...
    for iDay16 = 1 : length(ia16)-1
      ...
      avg16_btanom(iDay16,iChan) = nanmean(ysmooth(ind)) * 1;
  ...
  comment = 'see clust_convert_strowrates2oemrates_anomaly_nonucal.m';
  ...
  if i_obsORcal > 0
    fsave = ['/home/sergio/MATLABCODE/QUICKTASKS_TELECON/AIRS2CRIS_and_IASI2CRIS/sergio_airs2cris_decon/SergioRates/ANOM_16dayavg/latbin_' num2str(iAvgNumDays) 'dayavg_' num2str(iLatbin) '.mat'];
    saver = ['save ' fsave ' avg16_rtime avg_doy_since2012 avg16_btanom comment'];
  elseif i_obsORcal < 0
    fsave = ['/home/sergio/MATLABCODE/QUICKTASKS_TELECON/AIRS2CRIS_and_IASI2CRIS/sergio_airs2cris_decon/SergioRates/ANOM_16dayavg/latbin_' num2str(iAvgNumDays) 'dayavg_' num2str(iLatbin) '_cal.mat'];
    saver = ['save ' fsave ' avg16_rtime avg_doy_since2012 avg16_btanom comment'];
  end
...
iLatbin = 20;
  if i_obsORcal > 0  
    fin = ['/home/sergio/MATLABCODE/QUICKTASKS_TELECON/AIRS2CRIS_and_IASI2CRIS/sergio_airs2cris_decon/SergioRates/ANOM_16dayavg/latbin_' num2str(iAvgNumDays) 'dayavg_' num2str(iLatbin) '.mat'];
  else
    fin = ['/home/sergio/MATLABCODE/QUICKTASKS_TELECON/AIRS2CRIS_and_IASI2CRIS/sergio_airs2cris_decon/SergioRates/ANOM_16dayavg/latbin_' num2str(iAvgNumDays) 'dayavg_' num2str(iLatbin) '_cal.mat'];
  end
  load(fin)
