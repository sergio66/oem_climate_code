...
%    JOB sets timestep, code loops over 40 latbins .. so you need 365 processors
%---------------------------------------------------------------------------
...
%JOB = 20
%JOB = 122
%JOB = 90;  %% seem to be having NaNs in CO2 possibly because OBS has NaNs, do latbin 20
...
%---------------------------------------------------------------------------
% for this JOB timestep (1:365), loop over 40 latbins
%---------------------------------------------------------------------------
iLat0 = 11; iLatE = 31;
iLat0 = 21; iLatE = 21;
iLat0 =  1; iLatE = 40;
...
%JOB = 90; iLat0 =  18; iLatE = 18;  %% seem to be having NaNs in CO2 possibly because OBS has NaNs, do latbin 19, timestep 90
%JOB = 84; iLat0 =  18; iLatE = 18;  %% seem to be having NaNs in CO2 possibly because OBS has NaNs, do latbin 19, timestep 90
%JOB = 85; iLat0 =  18; iLatE = 18;  %% seem to be having NaNs in CO2 possibly because OBS has NaNs, do latbin 19, timestep 90
%JOB = 85; iLat0 =  20; iLatE = 20;  %% seem to be having NaNs in CO2 possibly because OBS has NaNs, do latbin 19, timestep 90
%JOB = 84; iLat0 =  19; iLatE = 20;  %% seem to be having NaNs in CO2 possibly because OBS has NaNs, do latbin 19, timestep 90

%JOB =  7; iLat0 =  20; iLatE = 20;  %% seem to be having NaNs in CO2 possibly because OBS has NaNs, do latbin 19, timestep 90
%JOB = 85; iLat0 =  20; iLatE = 20;  %% seem to be having NaNs in CO2 possibly because OBS has NaNs, do latbin 19, timestep 90
