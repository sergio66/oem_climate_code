...
% reduceL1L2 = [11 12 13];  %% alphaT alphaWV alphaO3
% RAalpha_sf = [1000 100 10 1 0.1 0.01 0.001 1e-16 1e-10];    %% larger alpha  makes retrieval stick to apriori; smaller makes it wiggle
% alpha_sf = 1; 
