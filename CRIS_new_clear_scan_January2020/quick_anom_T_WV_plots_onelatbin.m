...
%figname = '../AIRS_new_clear_scan_August2019/WORKS_Nov19_2019_fit_straight_spectral_rate/Figs/era_raw_o3_decadal_trends.fig';
%[latera,pressera,cera_o3] = get_fig_image_data(figname);
figname = '../AIRS_new_clear_scan_August2019/WORKS_Nov19_2019_fit_straight_spectral_rate/Figs/era_raw_wv_decadal_trends.fig';
[latera,pressera,cera_wv] = get_fig_image_data(figname);
figname = '../AIRS_new_clear_scan_August2019/WORKS_Nov19_2019_fit_straight_spectral_rate/Figs/era_raw_tz_decadal_trends.fig';
...
figure(12); plot(okdates,tzanom400);          title('Tz anom at 400 mb');     ylim([-0.5 +0.5]);
figure(13); plot(okdates,real(tzanomsig400)); title('Tz unc anom at 400 mb'); ylim([0 0.01]);

figure(14); colormap(llsmap4.llsmap4);
figure(15); colormap(llsmap4.llsmap4);
i400 = abs(playsN-400); i400 = find(i400 == min(i400));
wvanom400    = wv(:,i400);
wvanomsig400 = wv_sig(:,i400);
figure(14); plot(okdates,wvanom400);          title('Wv anom at 400 mb');     ylim([-0.5 +0.5]);
figure(15); plot(okdates,real(wvanomsig400)); title('Wv unc anom at 400 mb'); ylim([0 0.01]);
