...
%%% good!!!!%%%
driver.rateset.datafile  = '/home/sergio/MATLABCODE/RATES_TARO/MAT/overocean_gsx_1day_clr_era_lays_spanday01_avgL1Brates_robust_Nov02_2012_span_09_2002_08_2012.mat';
%%% good!!!!%%%
...
driver.rateset.datafile  = '/strowdata1/shared/sergio/MATLABCODE/oem_pkg_run/MakeERA_ratespectra/syntheticERArates.mat';
...
%driver.oem.lambda           = 1e-6;
%driver.oem.lambda_temp      = [ones(1,10)*1 ones(1,30)*0.005 ones(1,57)*0.001 ones(1,1)*(-9999)]*5;
%driver.oem.lambda_temp      = [ones(1,10)*1.00 ones(1,10)*0.90 ones(1,10)*0.80 ones(1,10)*0.70 ...
%                               ones(1,10)*0.65 ones(1,10)*0.60 ones(1,10)*0.55 ones(1,10)*0.50 ...
%                               ones(1,10)*0.475 ones(1,7)*0.450 ...
%                               ones(1,1)*(-9999)]*5;
%driver.oem.lambda_temp      = [ones(1,10)*0.50  ones(1,10)*0.55 ones(1,10)*0.60 ones(1,10)*0.65 ...
%                               ones(1,10)*0.70  ones(1,10)*0.75 ones(1,10)*0.80 ones(1,10)*0.85 ...
%                               ones(1,10)*0.875 ones(1,7)*0.900 ...
%                               ones(1,1)*(-9999)]*5;
